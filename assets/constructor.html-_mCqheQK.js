import{_ as n,o as t,c as e,e as c}from"./app-3RcBQnkC.js";const l={},i=c(`<p>构造函数，是一种特殊的方法。主要用来在创建对象时初始化对象，即为对象成员变量赋初始值，总与new运算符一起使用在创建对象的语句中。</p><pre><code>/**
* 矩形
*/
class Rectangle {
...
</code></pre>`,9),a=[i];function p(s,o){return t(),e("div",null,a)}const g=n(l,[["render",p],["__file","constructor.html.vue"]]);export{g as default};
