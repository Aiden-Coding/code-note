import{_ as t,o as e,c as o,a as n}from"./app-cCF93fuz.js";const r={},s=n("p",null,"ConcurrentSkipListMap是一个内部使用跳表，并且支持排序和并发的一个Map，是线程安全的。一般很少会被用到，也是一个比较偏门的数据结构。",-1),c=n("p",null,"简单介绍下跳表",-1),a=n("pre",null,[n("code",null,`跳表是一种允许在一个有顺序的序列中进行快速查询的数据结构。
