import{_ as l,r as t,o as c,c as d,a as n,b as s,d as e,e as i}from"./app-cCF93fuz.js";const o={},p=i('<h1 id="史上最通俗易懂的asm教程" tabindex="-1"><a class="header-anchor" href="#史上最通俗易懂的asm教程" aria-hidden="true">#</a> 史上最通俗易懂的ASM教程</h1><h2 id="一勺思想" tabindex="-1"><a class="header-anchor" href="#一勺思想" aria-hidden="true">#</a> 一勺思想</h2><p>We are all in the gutter, but some of us are looking at the stars. （我们都生活在阴沟里，但仍有人仰望星空 ）- 王尔德 《温德米尔夫人的扇子》</p><p>举世混浊我独清，众人皆醉我独醒 - 屈原 《楚辞》</p><h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2><p>ASM是一种通用Java字节码操作和分析框架。它可以用于修改现有的class文件或动态生成class文件。</p>',6),r={href:"https://asm.ow2.io/performance.html",target:"_blank",rel:"noopener noreferrer"},u=i(`<p>本篇文章分享的是对ASM的理解和应用，之前需要我们掌握<strong>class字节码</strong>，<strong>JVM基于栈的设计模式,JVM指令</strong></p><h2 id="class字节码" tabindex="-1"><a class="header-anchor" href="#class字节码" aria-hidden="true">#</a> class字节码</h2><p>我们编写的java文件，会通过javac命令编译为class文件，JVM最终会执行该类型文件来运行程序。下图所示为class文件结构。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/jvm/asm-43844b78-c01f-4990-b038-3c91ff2eeb34.jpg" alt=""></p><p>下面我们通过一个简单的实例来进行说明。下面是我们编写的一个简单的java文件，只是简单的函数调用.</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Test</span> <span class="token punctuation">{</span>
...
mv.visitMaxs(2, 3);
mv.visitEnd();
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以看出ASM是在指令层次上操作字节码的，和class字节码更加接近。如果我们有些字节码操作的需求，ASM一定可以实现的。只是使用起来比较麻烦一些。这里强烈推荐一款ASM插件</p><blockquote><p>https://plugins.jetbrains.com/plugin/5918-asm-bytecode-outline</p></blockquote><p>可以一键生成对应的ASM API代码</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/jvm/asm-3c8c8db4-5b6a-4576-b147-62965d0e0c1c.jpg" alt=""></p><hr><blockquote><p>参考链接：https://zhuanlan.zhihu.com/p/94498015</p></blockquote><hr>`,48),v={href:"https://github.com/itwanger/toBeBetterJavaer",target:"_blank",rel:"noopener noreferrer"},m={href:"https://javabetter.cn/overview/",target:"_blank",rel:"noopener noreferrer"},b=n("p",null,[s("微信搜 "),n("strong",null,"沉默王二"),s(" 或扫描下方二维码关注二哥的原创公众号沉默王二，回复 "),n("strong",null,"222"),s(" 即可免费领取。")],-1),k=n("p",null,[n("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/gongzhonghao.png",alt:""})],-1);function h(g,f){const a=t("ExternalLinkIcon");return c(),d("div",null,[p,n("blockquote",null,[n("p",null,[s("**ASM **is an all purpose Java bytecode manipulation and analysis framework. It can be used to modify existing classes or to dynamically generate classes, directly in binary form. ASM provides some common bytecode transformations and analysis algorithms from which custom complex transformations and code analysis tools can be built. ASM offers similar functionality as other Java bytecode frameworks, but is focused on"),n("a",r,[s("performance"),e(a)]),s(". Because it was designed and implemented to be as small and as fast as possible, it is well suited for use in dynamic systems (but can of course be used in a static way too, e.g. in compilers).")])]),u,n("p",null,[s("GitHub 上标星 10000+ 的开源知识库《"),n("a",v,[s("二哥的 Java 进阶之路"),e(a)]),s("》第一版 PDF 终于来了！包括Java基础语法、数组&字符串、OOP、集合框架、Java IO、异常处理、Java 新特性、网络编程、NIO、并发编程、JVM等等，共计 32 万余字，500+张手绘图，可以说是通俗易懂、风趣幽默……详情戳："),n("a",m,[s("太赞了，GitHub 上标星 10000+ 的 Java 教程"),e(a)])]),b,k])}const w=l(o,[["render",h],["__file","asm.html.vue"]]);export{w as default};
