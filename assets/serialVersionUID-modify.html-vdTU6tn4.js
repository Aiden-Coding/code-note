...
</code></pre><p>在没有定义<code>serialVersionUID</code>的时候，会调用<code>computeDefaultSUID</code> 方法，生成一个默认的<code>serialVersionUID</code>。</p><p>这也就找到了以上两个问题的根源，其实是代码中做了严格的校验。</p><h3 id="idea提示" tabindex="-1"><a class="header-anchor" href="#idea提示" aria-hidden="true">#</a> IDEA提示</h3><p>为了确保我们不会忘记定义<code>serialVersionUID</code>，可以调节一下Intellij IDEA的配置，在实现<code>Serializable</code>接口后，如果没定义<code>serialVersionUID</code>的话，IDEA（eclipse一样）会进行提示： <img src="http://www.hollischuang.com/wp-content/uploads/2018/12/15455657868672.jpg" alt="">￼</p><p>并且可以一键生成一个：</p><p><img src="http://www.hollischuang.com/wp-content/uploads/2018/12/15455658088098.jpg" alt="">￼</p><p>当然，这个配置并不是默认生效的，需要手动到IDEA中设置一下：</p><p><img src="http://www.hollischuang.com/wp-content/uploads/2018/12/15455659620042.jpg" alt="">￼</p><p>在图中标号3的地方（Serializable class without serialVersionUID的配置），打上勾，保存即可。</p><h3 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h3><p><code>serialVersionUID</code>是用来验证版本一致性的。所以在做兼容性升级的时候，不要改变类中<code>serialVersionUID</code>的值。</p><p>如果一个类实现了Serializable接口，一定要记得定义<code>serialVersionUID</code>，否则会发生异常。可以在IDE中通过设置，让他帮忙提示，并且可以一键快速生成一个<code>serialVersionUID</code>。</p><p>之所以会发生异常，是因为反序列化过程中做了校验，并且如果没有明确定义的话，会根据类的属性自动生成一个。</p>`,75),c=[r];function t(s,l){return i(),n("div",null,c)}const p=e(a,[["render",t],["__file","serialVersionUID-modify.html.vue"]]);export{p as default};
