import{_ as e,r as p,o as l,c as t,a as n,b as s,d as o,f as i,e as c}from"./app-3RcBQnkC.js";const d={},r={href:"https://shockerli.net/post/1000-line-mysql-note/",target:"_blank",rel:"noopener noreferrer"},u=c(`<p>非常不错的总结，强烈建议保存下来，需要的时候看一看。</p><h3 id="基本操作" tabindex="-1"><a class="header-anchor" href="#基本操作" aria-hidden="true">#</a> 基本操作</h3><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token comment">/* Windows服务 */</span>
...
6. SQL对大小写不敏感
7. 清除已有语句：\\c
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,47);function k(v,m){const a=p("ExternalLinkIcon");return l(),t("div",null,[n("blockquote",null,[n("p",null,[s("原文地址："),n("a",r,[s("https://shockerli.net/post/1000-line-mysql-note/"),o(a)]),s(" ，JavaGuide 对本文进行了简答排版，新增了目录。")])]),u,i(" @include: @article-footer.snippet.md ")])}const y=e(d,[["render",k],["__file","a-thousand-lines-of-mysql-study-notes.html.vue"]]);export{y as default};
