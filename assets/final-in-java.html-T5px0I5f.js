import{_ as a,o as n,c as e,e as i}from"./app-cCF93fuz.js";const l={},r=i(`<p>final是Java中的一个关键字，它所表示的是“这部分是无法修改的”。</p><p>使用 final 可以定义 ：变量、方法、类。</p><h3 id="final变量" tabindex="-1"><a class="header-anchor" href="#final变量" aria-hidden="true">#</a> final变量</h3><p>如果将变量设置为final，则不能更改final变量的值(它将是常量)。</p><pre><code>class Test{
