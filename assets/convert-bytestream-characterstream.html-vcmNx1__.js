import{_ as e,o as n,c as i,e as t}from"./app-cCF93fuz.js";const r={},s=t(`<p>想要实现字符流和字节流之间的相互转换需要用到两个类：</p><p>OutputStreamWriter 是字符流通向字节流的桥梁</p><p>InputStreamReader 是字节流通向字符流的桥梁</p><h3 id="字符流转成字节流" tabindex="-1"><a class="header-anchor" href="#字符流转成字节流" aria-hidden="true">#</a> 字符流转成字节流</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>
