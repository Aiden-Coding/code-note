import{_ as l,r as o,o as i,c,a as n,b as e,d as s,e as t}from"./app-cCF93fuz.js";const p={},r=n("p",null,"就在昨天，老板听我说完 Logback 有多牛逼之后，彻底动心了，对我下了死命令，“这么好的日志系统，你还不赶紧点，把它切换到咱的项目当中！”",-1),d=n("p",null,"我们项目之前用的 Log4j，在我看来，已经足够用了，毕竟是小公司，性能上的要求没那么苛刻。",-1),u=n("p",null,[n("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/gongju/logback-320329e9-a754-427f-8a19-2e4f809b6a6f.png",alt:""})],-1),g={href:"https://mp.weixin.qq.com/s/AXgNnJe8djD901EmhFkWUg",target:"_blank",rel:"noopener noreferrer"},v={href:"https://mp.weixin.qq.com/s/EhKf1rHWL-QII0f6eo0uVA",target:"_blank",rel:"noopener noreferrer"},m=n("h3",{id:"_01、logback-强在哪",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_01、logback-强在哪","aria-hidden":"true"},"#"),e(" 01、Logback 强在哪")],-1),b=n("p",null,"1）非常自然地实现了 SLF4J，不需要像 Log4j 和 JUL 那样加一个适配层。",-1),k=n("p",null,[n("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/gongju/logback-6ba1b465-5533-49dd-b875-48a10ba29f8e.png",alt:""})],-1),h=n("p",null,"2）Spring Boot 的默认日志框架使用的是 Logback。一旦某款工具库成为了默认选项，那就说明这款工具已经超过了其他竞品。",-1),f=n("p",null,[n("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/gongju/logback-2696cd8b-7e8c-4476-9a06-272fd22fa4b6.png",alt:""})],-1),q={href:"https://docs.spring.io/spring-boot/docs/current/reference/html/spring-boot-features.html#boot-features-logging",target:"_blank",rel:"noopener noreferrer"},y=t(`<p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/gongju/logback-82d78a15-8ae0-4377-a7af-aebd5cda4fda.png" alt=""></p><p>也可以通过源码的形式看得到：</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/gongju/logback-2df2d06e-1b01-428b-8444-d765056e25bb.png" alt=""></p><p>3）支持自动重新加载配置文件，不需要另外创建扫描线程来监视。</p><p>4）既然是巨佬的新作，那必然在性能上有了很大的提升，不然呢？</p><h3 id="_02、logback-使用示例" tabindex="-1"><a class="header-anchor" href="#_02、logback-使用示例" aria-hidden="true">#</a> 02、Logback 使用示例</h3><p><strong>第一步</strong>，在 pom.xml 文件中添加 Logback 的依赖：</p><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Maven 会自动导入另外两个依赖：</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/gongju/logback-1f7d8e00-4be6-4863-940c-037862ad2c41.png" alt=""></p><p>logback-core 是 Logback 的核心，logback-classic 是 SLF4J 的实现。</p><p><strong>第二步</strong>，来个最简单的测试用例：</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">import</span> <span class="token import"><span class="token namespace">org<span class="token punctuation">.</span>slf4j<span class="token punctuation">.</span></span><span class="token class-name">Logger</span></span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>粘贴到该网址的文本域：</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/gongju/logback-6c934584-3624-4f40-8108-13bfffc0c40b.png" alt=""></p><p>点击「Translate」，可以得到以下内容：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;
...
&lt;/configuration&gt;
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行后，可以在 target 目录下看到两个文件：debug.log 和 errror.log。</p><p><img src="https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/gongju/logback-536aa50e-b195-403e-8409-85e4f6966522.png" alt=""></p><p>到此为止，项目已经从 Log4j 切换到 Logback 了，过程非常的丝滑顺畅，嘿嘿。</p><h3 id="_04、logback-手册" tabindex="-1"><a class="header-anchor" href="#_04、logback-手册" aria-hidden="true">#</a> 04、Logback 手册</h3><p>Logback 的官网上是有一份手册的，非常详细，足足 200 多页，只不过是英文版的。小伙伴们可以看完我这篇文章入门实操的 Logback 教程后，到下面的地址看官方手册。</p>`,28),_={href:"http://logback.qos.ch/manual/index.html",target:"_blank",rel:"noopener noreferrer"},L=n("p",null,"如果英文阅读能力有限的话，可以到 GitHub 上查看雷锋翻译的中文版：",-1),F={href:"https://github.com/itwanger/logback-chinese-manual",target:"_blank",rel:"noopener noreferrer"},T=n("p",null,"当然了，还有一部分小伙伴喜欢看离线版的 PDF，我已经整理好了：",-1),R={href:"https://pan.baidu.com/s/16FrbwycYUUIfKknlLhRKYA",target:"_blank",rel:"noopener noreferrer"},S=n("p",null,[n("img",{src:"https://cdn.tobebetterjavaer.com/tobebetterjavaer/images/gongzhonghao.png",alt:""})],-1);function A(P,w){const a=o("ExternalLinkIcon");return i(),c("div",null,[r,d,u,n("p",null,[n("a",g,[e("Log4j"),s(a)]),e(" 介绍过了，"),n("a",v,[e("SLF4J"),s(a)]),e(" 也介绍过了，那接下来，你懂的，Logback 就要隆重地登场了，毕竟它哥仨有一个爹，那就是巨佬 Ceki Gulcu。")]),m,b,k,h,f,n("p",null,[e("注意看下图（证据找到了，来自 "),n("a",q,[e("Spring Boot 官网"),s(a)]),e("）：")]),y,n("blockquote",null,[n("p",null,[n("a",x,[e("http://logback.qos.ch/translator/"),s(a)])])]),j,n("blockquote",null,[n("p",null,[n("a",_,[e("http://logback.qos.ch/manual/index.html"),s(a)])])]),L,n("blockquote",null,[n("p",null,[n("a",F,[e("https://github.com/itwanger/logback-chinese-manual"),s(a)])])]),T,n("blockquote",null,[n("p",null,[e("链接:"),n("a",R,[e("https://pan.baidu.com/s/16FrbwycYUUIfKknlLhRKYA"),s(a)]),e(" 密码:bptl")])]),S])}const C=l(p,[["render",A],["__file","logback.html.vue"]]);export{C as default};
