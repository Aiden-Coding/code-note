import{_ as r,r as d,o,c as u,a as e,d as i,w as a,b as n,e as t}from"./app-3RcBQnkC.js";const v="/code-note/assets/image-51-ICy7vLQx.png",c="/code-note/assets/image-52-iz2Wt1i0.png",p="/code-note/assets/image-53-TpY4SKwh.png",m="/code-note/assets/image-54-owyC32oQ.png",b={},g=e("p",null,"ORM 框架的本质是简化操作数据库的编码工作，常用的框架有两个，一个是可以灵活执行动态 SQL 的 MyBatis；一个是崇尚不用写 SQL 的 Hibernate。前者互联网行业用的多，后者传统行业用的多。",-1),_=e("p",null,"Hibernate 的特点是所有的 SQL 通过 Java 代码生成，发展到最顶端的就是 Spring Data JPA，基本上根据方法名就可以生成对应的 SQL 了。",-1),q={href:"https://baomidou.com/",target:"_blank",rel:"noopener noreferrer"},h=t(`<h3 id="整合-mybatis" tabindex="-1"><a class="header-anchor" href="#整合-mybatis" aria-hidden="true">#</a> 整合 MyBatis</h3><p>第一步，在 pom.xml 文件中引入 starter。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;dependency&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>第三步，导入 SQL 文件。</p><p><img src="`+v+`" alt="Alt text"></p><p>第四步，新建 User.java 实体类。</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token annotation punctuation">@Data</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里使用了 lombok 的</p>`,10),x={href:"/Data",target:"_blank",rel:"noopener noreferrer"},M={href:"/Builder",target:"_blank",rel:"noopener noreferrer"},y={href:"/Builder",target:"_blank",rel:"noopener noreferrer"},f=e("code",null,"@Tolerate",-1),k=t(`<p>第五步，新建 UserMapper.java 接口：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public interface UserMapper {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),L={href:"/Select",target:"_blank",rel:"noopener noreferrer"},T={href:"/Insert",target:"_blank",rel:"noopener noreferrer"},S={href:"/Update",target:"_blank",rel:"noopener noreferrer"},P={href:"/Delete",target:"_blank",rel:"noopener noreferrer"},B={href:"/MapperScan",target:"_blank",rel:"noopener noreferrer"},A=t(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>@SpringBootApplication
@MapperScan
...
&lt;/select&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>细心的小伙伴应该可以看到 <code>\${ew.sqlSegment}</code> 这样的表达式，它属于 MyBatis-Plus 中的内容。</p><h3 id="通过-mybatis-plus-增强" tabindex="-1"><a class="header-anchor" href="#通过-mybatis-plus-增强" aria-hidden="true">#</a> 通过 MyBatis-Plus 增强</h3>`,21),C=e("p",null,"MP 提供了诸多优秀的特性，比如说：",-1),U=e("li",null,"强大的 CRUD 操作：内置了通用的 mapper、service，可通过少量的配置实现大部分常用的 CRUD，不用再编写 SQL 语句。",-1),w=e("li",null,"支持主键自动生成",-1),R=e("li",null,"支持 ActiveRecord 模式：实体类只需继承 Model 类即可进行强大的 CRUD 操作",-1),O=e("li",null,"内置分页插件",-1),D=e("li",null,"内置性能分析插件：可输出 SQL 语句以及其执行时间",-1),Q=t(`<p>我们直接进入实战。</p><p>第一步，在 pom.xml 文件中添加 MyBatis-Plus 的 starter。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;dependency&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对应的数据库表为 post-tag。</p><p><img src="`+p+`" alt="Alt text"></p><p>可以看得出，类名 PostTag，字段名 postTagId 和数据库表 post_tag、字段名 post_tag_id 并不一致，但 mp 自动帮我们做了映射关联。</p><p>第二步，新建 PostTagMapper 继承 BaseMapper，继承该接口后，无需编写 mapper.xml 文件，即可获得CRUD功能。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public interface PostTagMapper extends BaseMapper&lt;PostTag&gt; {}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>BaseMapper里提供的方法如下：</p><p><img src="`+m+'" alt="Alt text"></p><p>第三步，在测试类中添加查询方法。</p><hr><p>.</p><h3 id="源码路径" tabindex="-1"><a class="header-anchor" href="#源码路径" aria-hidden="true">#</a> 源码路径</h3>',16),j={href:"https://github.com/itwanger/coding-more",target:"_blank",rel:"noopener noreferrer"},N={href:"https://github.com/itwanger/codingmore-learning/tree/main/codingmore-mybatis",target:"_blank",rel:"noopener noreferrer"},J=e("hr",null,null,-1);function F(H,W){const l=d("RouterLink"),s=d("ExternalLinkIcon");return o(),u("div",null,[g,_,e("p",null,[i(l,{to:"/toBeBetterJavaer/springboot/jpa.html"},{default:a(()=>[n("Spring Boot 整合 JPA")]),_:1})]),e("p",null,[n("MyBatis 早些时候用起来比较繁琐，需要各种配置文件，需要实体类和 DAO 的映射关联，经过不断地演化和改进，可以通过 "),i(l,{to:"/toBeBetterJavaer/kaiyuan/auto-generator.html"},{default:a(()=>[n("generator")]),_:1}),n(" 自动生成实体类、配置文件和 DAO 层代码，简化了不少开发工作。")]),e("p",null,[n("随着 "),e("a",q,[n("MyBatis-Plus"),i(s)]),n(" 的出现，又进一步加速了 MyBatis 的发展。经过 MyBatis-Plus 的增强，开发者只需要简单的配置，就可以快速进行单表的 CRUD 操作；同时，MyBatis-Plus又提供了代码生成、自动分页、逻辑删除、自动填充等丰富功能，进一步简化了开发工作。")]),h,e("ul",null,[e("li",null,[e("a",x,[n("@Data"),i(s)]),n(" 注解自动生成 getter/setter")]),e("li",null,[e("a",M,[n("@Builder"),i(s)]),n(" 生成链式调用")]),e("li",null,[n("由于 @Data和"),e("a",y,[n("@Builder"),i(s)]),n(" 配合使用的时候会导致无参构造方法丢失，所以我们主动声明了无参构造方法，并使用 "),f,n(" 注解来告诉 lombok 请允许我们的无参构造方法存在（没有无参构造方法的时候会导致 ORM 映射出错）")])]),k,e("ul",null,[e("li",null,[e("a",L,[n("@Select"),i(s)]),n(" 注解用来查询")]),e("li",null,[e("a",T,[n("@Insert"),i(s)]),n(" 注解用来插入")]),e("li",null,[e("a",S,[n("@Update"),i(s)]),n(" 注解用来修改")]),e("li",null,[e("a",P,[n("@Delete"),i(s)]),n(" 注解用来删除")])]),e("p",null,[n("第六步，在启动类 CodingmoreMybatisApplication 上添加 "),e("a",B,[n("@MapperScan"),i(s)]),n(" 注解来扫描 mapper。")]),A,e("p",null,[n("如果没有指定 "),e("a",E,[n("@MapperScan"),i(s)]),n(" 的扫描路径，将从声明该注解的类的包开始进行扫描。")]),I,e("p",null,[n("MyBatis 属于半自动的 ORM 框架，实现一些简单的 CRUD 也是需要编写 SQL 语句，那如果想省掉这些步骤的话，可以选择 "),i(l,{to:"/toBeBetterJavaer/springboot/jpa.html"},{default:a(()=>[n("JPA")]),_:1}),n("，也可以选择国人开源的 MyBatis-Plus（简称 MP）。")]),C,e("ul",null,[U,w,R,e("li",null,[i(l,{to:"/toBeBetterJavaer/kaiyuan/auto-generator.html"},{default:a(()=>[n("强大的代码生成器")]),_:1}),n("：可快速生成 Mapper 、 Model 、 Service 、 Controller 层代码")]),O,D]),Q,e("ul",null,[e("li",null,[n("编程喵："),e("a",j,[n("https://github.com/itwanger/coding-more"),i(s)])]),e("li",null,[n("codingmore-mybatis："),e("a",N,[n("https://github.com/itwanger/codingmore-learning"),i(s)])])]),J])}const z=r(b,[["render",F],["__file","mybatis.html.vue"]]);export{z as default};
