import{_ as i,o as n,c as e,e as l}from"./app-cCF93fuz.js";const s={},v=l(`<p>如果你的图相对较小且比较密集，而且你更注重简单性和空间效率，数组实现可能更合适。</p><p>如果你的图规模较大，尤其是在稀疏图中，而且你更注重时间效率和通用性，优先级队列实现可能更合适。</p><p>其关键 在于弄清楚 minDist 的定义</p><div class="language-CPP line-numbers-mode" data-ext="CPP"><pre class="language-CPP"><code>
#include &lt;iostream&gt;
#include &lt;vector&gt;
#include &lt;queue&gt;
#include &lt;climits&gt;
