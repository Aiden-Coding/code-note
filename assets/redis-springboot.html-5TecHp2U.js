import{_ as t,r as i,o as p,c as l,a as n,b as s,d as e,e as c}from"./app-3RcBQnkC.js";const o="/code-note/assets/image-5-4_1r0eDE.png",u="/code-note/assets/image-6-HkHxgmvA.png",d="/code-note/assets/image-7-Bpst5zhH.png",r="/code-note/assets/image-8-k5oEaT4b.png",v="/code-note/assets/image-9-cLbbW9py.png",m="/code-note/assets/image-10-cYyJy2_9.png",k="/code-note/assets/image-11-t5QEEoN3.png",g="/code-note/assets/image-12-22Y8hBiU.png",b="/code-note/assets/image-13-vCWksB28.png",h="/code-note/assets/image-14-O8dngKUZ.png",_="/code-note/assets/image-15-WqMsKc1d.png",f="/code-note/assets/image-16-lJyFUvBy.png",x="/code-note/assets/image-17-Ca2JdFXL.png",y="/code-note/assets/image-18-SXdMHXY7.png",R="/code-note/assets/image-19-U3zfBCh9.png",S="/code-note/assets/image-20-0ZA_u7rd.png",w="/code-note/assets/image-21-CsycF7kR.png",T="/code-note/assets/image-22-xdWbBbyc.png",C="/code-note/assets/image-23--GzS7TSF.png",q="/code-note/assets/image-24-t-_gbc1a.png",j={},A=n("p",null,"作为开发者，相信大家都知道 Redis 的重要性。Redis 是使用 C 语言开发的一个高性能键值对数据库，是互联网技术领域使用最为广泛的存储中间件，它是「Remote Dictionary Service」的首字母缩写，也就是「远程字典服务」。",-1),O=n("p",null,"Redis 以超高的性能、完美的文档、简洁的源码著称，国内外很多大型互联网公司都在用，比如说阿里、腾讯、GitHub、Stack Overflow 等等。当然了，中小型公司也都在用。",-1),I=n("h2",{id:"安装-redis",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#安装-redis","aria-hidden":"true"},"#"),s(" 安装 Redis")],-1),z=n("p",null,"Redis 的官网提供了各种平台的安装包，Linux、macOS、Windows 的都有。",-1),P=n("p",null,[n("img",{src:o,alt:"Alt text"})],-1),F={href:"https://redis.io/docs/getting-started/",target:"_blank",rel:"noopener noreferrer"},L=n("p",null,[s("我目前用的是 macOS，直接执行 "),n("code",null,"brew install redis"),s(" 就可以完成安装了。")],-1),B=n("p",null,[n("img",{src:u,alt:"Alt text"})],-1),J=n("p",null,[s("完成安装后执行 "),n("code",null,"redis-server"),s(" 就可以启动 Redis 服务了。")],-1),M=n("p",null,[n("img",{src:d,alt:"Alt text"})],-1),V={href:"https://mp.weixin.qq.com/s/Hgm3ZAbOeBqpSUsJZBtlNg",target:"_blank",rel:"noopener noreferrer"},E=n("code",null,"choco install redis",-1),W=n("p",null,[n("img",{src:r,alt:"Alt text"})],-1),D=n("p",null,"生产环境中，我们通常会在 Linux 上安装 Redis。我的服务器上安装了宝塔面板，可以直接在软件商店里搜「Redis」关键字，然后直接安装（我已经安装过了）。",-1),N=n("p",null,[n("img",{src:v,alt:"Alt text"})],-1),H=n("p",null,"顺带安装一下 Redis 客户端工具，推荐 GitHub 星标 20k+ 的 AnotherRedisDesktopManager，一款 🚀🚀🚀 更快、更好、更稳定的Redis桌面(GUI)管理客户端，支持 Windows、macOS 和 Linux，性能出众，可以轻松加载海量键值。",-1),K={href:"https://github.com/qishibo/AnotherRedisDesktopManager",target:"_blank",rel:"noopener noreferrer"},U=n("p",null,"安装完成后，链接 Redis 服务：",-1),G=n("p",null,[n("img",{src:m,alt:"Alt text"})],-1),Y=n("h2",{id:"redis-数据类型",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#redis-数据类型","aria-hidden":"true"},"#"),s(" Redis 数据类型")],-1),X=n("p",null,"Redis支持五种数据类型：string（字符串），hash（哈希），list（列表），set（集合）及zset(sorted set：有序集合)。",-1),Z={href:"https://www.redis.net.cn/tutorial/3508.html",target:"_blank",rel:"noopener noreferrer"},Q=c('<p><strong>1）string</strong></p><p>string 是 Redis 最基本的数据类型，一个key对应一个value。</p><p>我们可以通过 AnotherRedisDesktopManager 客户端来练习一下基本的 set、get 命令（参考 Redis 文档，客户端会有提示，所以命令完全不用死记硬背）。</p><p><img src="'+k+`" alt="Alt text"></p><p>对应文本命令：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>## 增加一个 key 为 name，value 为 沉默王二
&gt; set name &#39;沉默王二&#39;
OK
## 获取
&gt; get name
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>RedisTemplate 和 StringRedisTemplate 都是 Spring Data Redis 提供的模板类，可以对 Redis 进行操作，后者针对键值对都是 String 类型的数据，前者可以是任何类型的对象。</p><p>RedisTemplate 和 StringRedisTemplate 除了提供 opsForValue 方法来操作字符串之外，还提供了以下方法：</p><ul><li>opsForList：操作 list</li><li>opsForSet：操作 set</li><li>opsForZSet：操作有序 set</li><li>opsForHash：操作 hash</li></ul><p>运行测试类后可以在控制台看到以下输出信息：</p><p><img src="`+g+'" alt="Alt text"></p><p>也可以通过 AnotherRedisDesktopManager 客户端查看 Redis 数据库中的数据。</p><p><img src="'+b+'" alt="Alt text"></p><h2 id="编程喵整合-redis" tabindex="-1"><a class="header-anchor" href="#编程喵整合-redis" aria-hidden="true">#</a> 编程喵整合 Redis</h2><p>编程喵是一个 Spring Boot + Vue 的前后端分离项目，要整合 Redis 的话，最好的方式是使用 Spring Cache，仅仅通过 @Cacheable、@CachePut、@CacheEvict、@EnableCaching 等注解就可以轻松使用 Redis 做缓存了。</p><p><img src="'+h+'" alt="Alt text"></p><p><strong>1）@EnableCaching</strong>，开启缓存功能。</p><p><strong>2）@Cacheable</strong>，调用方法前，去缓存中找，找到就返回，找不到就执行方法，并将返回值放到缓存中。</p><p><strong>3）@CachePut</strong>，方法调用前不会去缓存中找，无论如何都会执行方法，执行完将返回值放到缓存中。</p><p><strong>4）@CacheEvict</strong>，清理缓存中的一个或多个记录。</p><p>Spring Cache 是 Spring 提供的一套完整的缓存解决方案，虽然它本身没有提供缓存的实现，但它提供的一整套接口、规范、配置、注解等，可以让我们无缝衔接 Redis、Ehcache 等缓存实现。</p><p>Spring Cache 的注解（前面提到的四个）会在调用方法之后，去缓存方法返回的最终结果；或者在方法调用之前拿缓存中的结果，当然还有删除缓存中的结果。</p><p>这些读写操作不用我们手动再去写代码实现了，直接交给 Spring Cache 来打理就 OK 了，是不是非常贴心？</p><p><img src="'+_+`" alt="Alt text"></p><p><strong>第一步</strong>，在 pom.xml 文件中追加 Redis 的 starter。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;dependency&gt;
    &lt;groupId&gt;org.springframework.boot&lt;/groupId&gt;
    &lt;artifactId&gt;spring-boot-starter-data-redis&lt;/artifactId&gt;
&lt;/dependency&gt;
...
<span class="token punctuation">}</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul><li>value：缓存名称，也就是缓存的命名空间，value 这里应该换成 namespace 更好一点；</li><li>key：用于在命名空间中缓存的 key 值，可以使用 SpEL 表达式，比如说 <code>&#39;codingmore:postag:&#39;+#postAddTagParam.postTagId</code>；</li><li>还有两个属性 unless 和 condition 暂时没用到，分别表示条件符合则不缓存，条件符合则缓存。</li></ul><p><strong>第五步</strong>，启动服务器端，启动客户端，修改标签进行测试。</p><p><img src="`+f+'" alt="Alt text"></p><p>通过 Red 客户端（一款 macOS 版的 Redis 桌面工具），可以看到刚刚更新的返回值已经添加到 Redis 中了。</p><p><img src="'+x+'" alt="Alt text"></p><h2 id="使用-redis-连接池" tabindex="-1"><a class="header-anchor" href="#使用-redis-连接池" aria-hidden="true">#</a> 使用 Redis 连接池</h2><p>Redis 是基于内存的数据库，本来是为了提高程序性能的，但如果不使用 Redis 连接池的话，建立连接、断开连接就需要消耗大量的时间。</p><p>用了连接池，就可以实现在客户端建立多个连接，需要的时候从连接池拿，用完了再放回去，这样就节省了连接建立、断开的时间。</p><p>要使用连接池，我们得先了解 Redis 的客户端，常用的有两种：Jedis 和 Lettuce。</p><ul><li>Jedis：Spring Boot 1.5.x 版本时默认的 Redis 客户端，实现上是直接连接 Redis Server，如果在多线程环境下是非线程安全的，这时候要使用连接池为每个 jedis 实例增加物理连接；</li><li>Lettuce：Spring Boot 2.x 版本后默认的 Redis 客户端，基于 Netty 实现，连接实例可以在多个线程间并发访问，一个连接实例不够的情况下也可以按需要增加连接实例。</li></ul><p>它俩在 GitHub 上都挺受欢迎的，大家可以按需选用。</p><p><img src="'+y+`" alt="Alt text"></p><p>我这里把两种客户端的情况都演示一下，方便小伙伴们参考。</p><p><strong>1）Lettuce</strong></p><p><strong>第一步</strong>，修改 application-dev.yml，添加 Lettuce 连接池配置（pool 节点）。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>spring:
    redis:
        lettuce:
          pool:
    ...
    &lt;scope&gt;compile&lt;/scope&gt;
&lt;/dependency&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>重新启动服务，在 RedisConfig 类的 redisTemplate 方法里对 redisTemplate 打上断点，debug 模式下可以看到连接池的配置信息（<code>redisConnectionFactory→clientConfiguration→poolConfig</code>）。如下图所示。</p><p><img src="`+R+'" alt="Alt text"></p><p>如果在 application-dev.yml 文件中没有添加 Lettuce 连接池配置的话，是不会看到</p><p><img src="'+S+`" alt="Alt text"></p><p><strong>2）Jedis</strong></p><p><strong>第一步</strong>，在 pom.xml 文件中添加 Jedis 依赖，去除 Lettuce 默认依赖。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;dependency&gt;
    &lt;groupId&gt;org.springframework.boot&lt;/groupId&gt;
    &lt;artifactId&gt;spring-boot-starter-data-redis&lt;/artifactId&gt;
    &lt;exclusions&gt;
        &lt;exclusion&gt;
    ...
    redis:
        jedis:
          pool:
            ...
            min-idle: 0 # 连接池最小空闲连接数
            max-wait: -1ms # 连接池最大阻塞等待时间，负值表示没有限制
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>启动服务后，观察 redisTemplate 的 clientConfiguration 节点，可以看到它的值已经变成 DefaultJedisClientConfiguration 对象了。</p><p><img src="`+w+'" alt="Alt text"></p><p>当然了，也可以不配置 Jedis 客户端的连接池，走默认的连接池配置。因为 Jedis 客户端默认增加了连接池的依赖包，在 pom.xml 文件中点开 Jedis 客户端依赖可以查看到。</p><p><img src="'+T+'" alt="Alt text"></p><h2 id="自由操作-redis" tabindex="-1"><a class="header-anchor" href="#自由操作-redis" aria-hidden="true">#</a> 自由操作 Redis</h2><p>Spring Cache 虽然提供了操作 Redis 的便捷方法，比如我们前面演示的 @CachePut 注解，但注解提供的操作非常有限，比如说它只能保存返回值到缓存中，而返回值并不一定是我们想要保存的结果。</p><p><img src="'+C+'" alt="Alt text"></p><p>与其保存这个返回给客户端的 JSON 信息，我们更想保存的是更新后的标签。那该怎么自由地操作 Redis 呢？</p><p><img src="'+q+`" alt="Alt text"></p><p><strong>第一步</strong>，增加 RedisService 接口：</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">RedisService</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>第三步</strong>，在标签 PostTagController 中增加 Redis 测试用接口 simpleTest ：</p><hr><p>.</p><hr><h2 id="项目源码" tabindex="-1"><a class="header-anchor" href="#项目源码" aria-hidden="true">#</a> 项目源码</h2>`,102),$={href:"https://github.com/itwanger/coding-more",target:"_blank",rel:"noopener noreferrer"},nn={href:"https://github.com/itwanger/codingmore-learning/tree/main/codingmore-redis",target:"_blank",rel:"noopener noreferrer"};function sn(an,en){const a=i("ExternalLinkIcon");return p(),l("div",null,[A,O,I,z,P,n("blockquote",null,[n("p",null,[s("官方地址："),n("a",F,[s("https://redis.io/docs/getting-started/"),e(a)])])]),L,B,J,M,n("p",null,[s("Windows 用户可以通过我之前提到的 "),n("a",V,[s("chocolatey 命令行软件管理神器"),e(a)]),s("安装（可以戳链接了解详情），只需要一行命令 "),E,s(" 就可以完成安装了，非常方便。")]),W,D,N,H,n("blockquote",null,[n("p",null,[n("a",K,[s("https://github.com/qishibo/AnotherRedisDesktopManager"),e(a)])])]),U,G,Y,X,n("blockquote",null,[n("p",null,[s("Redis 教程："),n("a",Z,[s("https://www.redis.net.cn/tutorial/3508.html"),e(a)])])]),Q,n("blockquote",null,[n("ul",null,[n("li",null,[s("编程喵："),n("a",$,[s("https://github.com/itwanger/coding-more"),e(a)])]),n("li",null,[s("整合 Redis 专用："),n("a",nn,[s("https://github.com/itwanger/coding-more"),e(a)])])])])])}const pn=t(j,[["render",sn],["__file","redis-springboot.html.vue"]]);export{pn as default};
