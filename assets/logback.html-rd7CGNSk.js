import{_ as l,r as o,o as i,c,a as n,b as s,d as a,e as t}from"./app-3RcBQnkC.js";const p="/code-note/assets/image-84-qGErxwRT.png",r="/code-note/assets/image-64-IOm30oNP.png",d="/code-note/assets/image-86-KvXQ6fiC.png",u="/code-note/assets/image-66-Z-hs17Il.png",g="/code-note/assets/image-67-phDI5Q_a.png",v="/code-note/assets/image-89-re0DYuEx.png",m="/code-note/assets/image-90-T-olz1mq.png",b="/code-note/assets/image-91-xivvWKTw.png",k="/code-note/assets/image-92-zWvw3qfQ.png",h="/code-note/assets/image-93-p0kQqaJy.png",q="/code-note/assets/image-94-HNoSYG_o.png",f={},y=n("p",null,"就在昨天，老板听我说完 Logback 有多牛逼之后，彻底动心了，对我下了死命令，“这么好的日志系统，你还不赶紧点，把它切换到咱的项目当中！”",-1),x=n("p",null,"我们项目之前用的 Log4j，在我看来，已经足够用了，毕竟是小公司，性能上的要求没那么苛刻。",-1),_=n("p",null,[n("img",{src:p,alt:"Alt text"})],-1),L={href:"https://mp.weixin.qq.com/s/AXgNnJe8djD901EmhFkWUg",target:"_blank",rel:"noopener noreferrer"},A={href:"https://mp.weixin.qq.com/s/EhKf1rHWL-QII0f6eo0uVA",target:"_blank",rel:"noopener noreferrer"},F=n("h3",{id:"_01、logback-强在哪",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_01、logback-强在哪","aria-hidden":"true"},"#"),s(" 01、Logback 强在哪")],-1),T=n("p",null,"1）非常自然地实现了 SLF4J，不需要像 Log4j 和 JUL 那样加一个适配层。",-1),R=n("p",null,[n("img",{src:r,alt:"Alt text"})],-1),j=n("p",null,"2）Spring Boot 的默认日志框架使用的是 Logback。一旦某款工具库成为了默认选项，那就说明这款工具已经超过了其他竞品。",-1),S=n("p",null,[n("img",{src:d,alt:"Alt text"})],-1),P={href:"https://docs.spring.io/spring-boot/docs/current/reference/html/spring-boot-features.html#boot-features-logging",target:"_blank",rel:"noopener noreferrer"},w=t('<p><img src="'+u+'" alt="Alt text"></p><p>也可以通过源码的形式看得到：</p><p><img src="'+g+`" alt="Alt text"></p><p>3）支持自动重新加载配置文件，不需要另外创建扫描线程来监视。</p><p>4）既然是巨佬的新作，那必然在性能上有了很大的提升，不然呢？</p><h3 id="_02、logback-使用示例" tabindex="-1"><a class="header-anchor" href="#_02、logback-使用示例" aria-hidden="true">#</a> 02、Logback 使用示例</h3><p><strong>第一步</strong>，在 pom.xml 文件中添加 Logback 的依赖：</p><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Maven 会自动导入另外两个依赖：</p><p><img src="`+v+`" alt="Alt text"></p><p>logback-core 是 Logback 的核心，logback-classic 是 SLF4J 的实现。</p><p><strong>第二步</strong>，来个最简单的测试用例：</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">import</span> <span class="token import"><span class="token namespace">org<span class="token punctuation">.</span>slf4j<span class="token punctuation">.</span></span><span class="token class-name">Logger</span></span><span class="token punctuation">;</span>
...
&lt;/configuration&gt;
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行后，可以在 target 目录下看到两个文件：debug.log 和 errror.log。</p><p><img src="`+q+'" alt="Alt text"></p><p>到此为止，项目已经从 Log4j 切换到 Logback 了，过程非常的丝滑顺畅，嘿嘿。</p><h3 id="_04、logback-手册" tabindex="-1"><a class="header-anchor" href="#_04、logback-手册" aria-hidden="true">#</a> 04、Logback 手册</h3><p>Logback 的官网上是有一份手册的，非常详细，足足 200 多页，只不过是英文版的。小伙伴们可以看完我这篇文章入门实操的 Logback 教程后，到下面的地址看官方手册。</p>',28),C={href:"http://logback.qos.ch/manual/index.html",target:"_blank",rel:"noopener noreferrer"},E=n("p",null,"如果英文阅读能力有限的话，可以到 GitHub 上查看雷锋翻译的中文版：",-1),B={href:"https://github.com/itwanger/logback-chinese-manual",target:"_blank",rel:"noopener noreferrer"},O=n("p",null,"当然了，还有一部分小伙伴喜欢看离线版的 PDF，我已经整理好了：",-1),H={href:"https://pan.baidu.com/s/16FrbwycYUUIfKknlLhRKYA",target:"_blank",rel:"noopener noreferrer"};function I(M,G){const e=o("ExternalLinkIcon");return i(),c("div",null,[y,x,_,n("p",null,[n("a",L,[s("Log4j"),a(e)]),s(" 介绍过了，"),n("a",A,[s("SLF4J"),a(e)]),s(" 也介绍过了，那接下来，你懂的，Logback 就要隆重地登场了，毕竟它哥仨有一个爹，那就是巨佬 Ceki Gulcu。")]),F,T,R,j,S,n("p",null,[s("注意看下图（证据找到了，来自 "),n("a",P,[s("Spring Boot 官网"),a(e)]),s("）：")]),w,n("blockquote",null,[n("p",null,[n("a",D,[s("http://logback.qos.ch/translator/"),a(e)])])]),N,n("blockquote",null,[n("p",null,[n("a",C,[s("http://logback.qos.ch/manual/index.html"),a(e)])])]),E,n("blockquote",null,[n("p",null,[n("a",B,[s("https://github.com/itwanger/logback-chinese-manual"),a(e)])])]),O,n("blockquote",null,[n("p",null,[s("链接:"),n("a",H,[s("https://pan.baidu.com/s/16FrbwycYUUIfKknlLhRKYA"),a(e)]),s(" 密码:bptl")])])])}const z=l(f,[["render",I],["__file","logback.html.vue"]]);export{z as default};
