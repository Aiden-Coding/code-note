import{_ as i,r as l,o,c,a as n,b as a,d as e,e as t}from"./app-3RcBQnkC.js";const p="/code-note/assets/image-7-2KFsMCca.png",r="/code-note/assets/image-8-7rdcTpEr.png",u="/code-note/assets/image-9-JRrOp7xK.png",d="/code-note/assets/image-10-SEzFd2-a.png",m="/code-note/assets/image-11-68yu8jPs.png",v="/code-note/assets/image-12-pwQp6riN.png",g="/code-note/assets/image-13-Wzl8md01.png",b="/code-note/assets/image-14-oCpGoFWW.png",k="/code-note/assets/image-15-iHYJ7PI8.png",y="/code-note/assets/image-16-9Sx4Oe3C.png",h="/code-note/assets/image-17-kMXiON2d.png",q="/code-note/assets/image-18-18tA-sLZ.png",f={},_=n("p",null,"作为一名 Java 后端开发，日常工作中免不了要生成数据库表对应的持久化对象 PO，操作数据库的接口 DAO，以及 CRUD 的 XML，也就是 mapper。",-1),x=n("p",null,"Mybatis Generator 是 MyBatis 官方提供的一个代码生成工具，完全可以胜任这个工作，不过最近在开发“编程喵🐱”开源网站的时候试用了一下 MyBatis-Plus 官方提供 AutoGenerator，发现配置更简单，开发效率更高！于是就来给小伙伴们安利一波。",-1),M=n("p",null,"让我们来通过一个 gif 感受一下 AutoGenerator 的强大。",-1),j=n("p",null,[n("img",{src:p,alt:"Alt text"})],-1),G=n("h2",{id:"导入-sql-文件",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#导入-sql-文件","aria-hidden":"true"},"#"),a(" 导入 SQL 文件")],-1),C=n("p",null,"编程喵项目的 SQL 文件我已经同步到本教程所在的源码当中。",-1),I={href:"https://github.com/itwanger/codingmore-learning/tree/main/codingmore-autogenerator",target:"_blank",rel:"noopener noreferrer"},B=t('<p>可以通过 GitHub 桌面版从 GitHub 上下载本教程专属的项目 codingmore-autogenerator 到本地，SQL 文件的位置参照下图。</p><p><img src="'+r+'" alt="Alt text"></p><p>编程喵使用的 MySQL 版本是 8.0，可以在链接上 MySQL 后使用 <code>select version();</code> 命令查询版本。</p><p><img src="'+u+'" alt="Alt text"></p><p>打开 Navicat，把 SQL 文件导入到本地数据库，</p><p><img src="'+d+'" alt="Alt text"></p><p>关闭链接，重新打开就可以看到导入后的数据库 codingmore，里面一共 27 张表。</p><p><img src="'+m+`" alt="Alt text"></p><h2 id="先体验-mybatis-generator" tabindex="-1"><a class="header-anchor" href="#先体验-mybatis-generator" aria-hidden="true">#</a> 先体验 Mybatis Generator</h2><p>第一步，在 pom.xml 文件中添加 MySQL+MyBatis 的依赖（Mybatis Generator 的前置条件）。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;dependency&gt;
...
&lt;dependency&gt;
    ...
    &lt;scope&gt;runtime&lt;/scope&gt;
&lt;/dependency&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>添加完成后，一定要执行一次 Maven 重载（见下图），确保 MyBatis 的依赖加载完毕后再执行第二步。</p><p><img src="`+v+'" alt="Alt text"></p><p>否则下一步可能不通过，但又得不到任何错误提示。不要问我为什么，踩过坑后痛苦的领悟。</p><p><img src="'+g+'" alt="Alt text"></p><p>添加完成后，可以通过 Maven 插件来生成骨架代码，也可以通过 Java 代码来生成骨架代码，这里以 Maven 插件的形式来演示。Java 代码的形式可参照 Mybatis Generator：</p>',16),A={href:"https://mybatis.org/generator/running/runningWithJava.html",target:"_blank",rel:"noopener noreferrer"},w=t(`<p>第二步，在 pom.xml 文件中，添加 MyBatis Generator 插件，注意是在 <strong>build→plugins</strong> 下节点下添加。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;!-- MyBatis Generator 插件 --&gt;
&lt;plugin&gt;
    ...
    &lt;/configuration&gt;
&lt;/plugin&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>MyBatis Generator 插件目前最新版是 1.4.0，我们采用上一个稳定版本 1.3.7，新版本容易有坑。</p><p>来看一下添加 MyBatis Generator 插件后 pom.xml 文件的结构图。</p><p><img src="`+b+`" alt="Alt text"></p><p>只添加插件还不够，还需要对其进行配置，我们使用 configurationFile 元素来指定一个配置文件 mybatis-generator-config.xml：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;configurationFile&gt;src/main/resources/mybatis-generator-config.xml&lt;/configurationFile&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>来看一下 mybatis-generator-config.xml 的位置。</p><p><img src="`+k+`" alt="Alt text"></p><p>来看一下 mybatis-generator-config.xml 的内容。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;generatorConfiguration&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>配置文件至少得包含一个context</li><li>commentGenerator 用来配置生成的注释</li><li>jdbcConnection 用来链接数据库</li><li>javaTypeResolver 配置 JDBC 与 Java 的类型转换规则</li><li>javaModelGenerator 配置 po 生成的包路径和项目路径</li><li>sqlMapGenerator 配置 mapper.xml 文件生成的目录</li><li>javaClientGenerator 配置 mapper.java 文件生成的目录</li><li>一个 table 对应一张表，如果想同时生成多张表，需要配置多个 table</li></ul><p>更多配置信息可以参照下面这篇文章：</p>`,18),P={href:"https://juejin.cn/post/6844903982582743048",target:"_blank",rel:"noopener noreferrer"},D=t('<p>到此为止，mybatis-generator-maven-plugin 就算是配置完成了，完整内容如下图所示：</p><p><img src="'+y+'" alt="Alt text"></p><p>配置完成后可以双击运行 Maven 的插件 Mybatis Generator，没有问题的话，可以看到生成后的文件。</p><p><img src="'+h+'" alt="Alt text"></p><h2 id="再体验-mybatis-plus-的-autogenerator" tabindex="-1"><a class="header-anchor" href="#再体验-mybatis-plus-的-autogenerator" aria-hidden="true">#</a> 再体验 MyBatis-Plus 的 AutoGenerator</h2><p>MyBatis-Plus（简写 MP）是 MyBatis 的增强工具，官方宣称 MP 和 MyBatis 的关系就好像魂斗罗中的 1P 和 2P，可谓好基友，天下走。</p><p><img src="'+q+`" alt="Alt text"></p><p>AutoGenerator 是 MyBatis-Plus 推出的代码生成器，可以快速生成 Entity、Mapper、Mapper XML、Service、Controller 等各个模块的代码，比 Mybatis Generator 更强大，开发效率更高。</p><p>通过前面的体验，想必大家确实感觉到了 Mybatis Generator 的繁琐，接下来，我们来体验一下 AutoGenerator，对比过后，大家心里就有答案了。</p><p>第一步，在 pom.xml 文件中添加 AutoGenerator 的依赖。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;dependency&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>更多配置项可以到官方查看：</p>`,22),S={href:"https://baomidou.com/pages/061573/",target:"_blank",rel:"noopener noreferrer"},E=n("p",null,"完整代码如下所示：",-1),L=n("hr",null,null,-1),N=n("p",null,".",-1),T=n("hr",null,null,-1),J=n("h2",{id:"源码地址",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#源码地址","aria-hidden":"true"},"#"),a(" 源码地址：")],-1),O={href:"https://github.com/itwanger/coding-more",target:"_blank",rel:"noopener noreferrer"},Q={href:"https://github.com/itwanger/codingmore-learning/tree/main/codingmore-autogenerator",target:"_blank",rel:"noopener noreferrer"},R=n("hr",null,null,-1);function F(U,X){const s=l("ExternalLinkIcon");return o(),c("div",null,[_,x,M,j,G,C,n("blockquote",null,[n("p",null,[a("路径："),n("a",I,[a("https://github.com/itwanger/codingmore-learning/tree/main/codingmore-autogenerator"),e(s)])])]),B,n("blockquote",null,[n("p",null,[n("a",A,[a("https://mybatis.org/generator/running/runningWithJava.html"),e(s)])])]),w,n("blockquote",null,[n("p",null,[n("a",P,[a("https://juejin.cn/post/6844903982582743048"),e(s)])])]),D,n("blockquote",null,[n("p",null,[n("a",S,[a("https://baomidou.com/pages/061573/"),e(s)])])]),E,L,N,T,J,n("blockquote",null,[n("ul",null,[n("li",null,[a("编程喵："),n("a",O,[a("https://github.com/itwanger/coding-more"),e(s)])]),n("li",null,[a("codingmore-autogenerator："),n("a",Q,[a("https://github.com/itwanger/codingmore-learning"),e(s)])])])]),R])}const W=i(f,[["render",F],["__file","auto-generator.html.vue"]]);export{W as default};
