import{_ as e,r as t,o as p,c as i,a as n,b as s,d as o,e as l}from"./app-3RcBQnkC.js";const c={},r=n("h1",{id:"第5章-turbine-监控信息聚合展示-hystrix",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#第5章-turbine-监控信息聚合展示-hystrix","aria-hidden":"true"},"#"),s(" 第5章：Turbine 监控信息聚合展示 Hystrix")],-1),u=n("br",null,null,-1),d={href:"https://bugstack.cn",target:"_blank",rel:"noopener noreferrer"},k=l(`<blockquote><p>沉淀、分享、成长，让自己和他人都能有所收获！😄</p></blockquote><h2 id="前言介绍" tabindex="-1"><a class="header-anchor" href="#前言介绍" aria-hidden="true">#</a> 前言介绍</h2><p>Hystrix Dashboard 可以定时收集接口调用信息；时长、次数、性能、熔断等各项指标来进行监控展示，但是我们每次监控都需要输入一个Hystrix 的链接例如：http://localhost:9001/actuator/hystrix.stream，但是这样并不利于我们去做整体服务的监控，并且在实际使用的过程中如果是几十到几百个接口那么这样的监控几乎达不到监控效果，就累死在监控路上了。因此我们需要使用到 Turbine 来进行监控信息聚合，可以按业务组定义配置方便监控。</p><h2 id="案例说明" tabindex="-1"><a class="header-anchor" href="#案例说明" aria-hidden="true">#</a> 案例说明</h2><p>案例通过添加itstack-demo-springcloud-turbine工程模块，将单体监控汇总在统一页面进行管理，此时的监控模型，如图； <img src="https://bugstack.cn/assets/images/pic-content/2019/11/springcloud-5-1.png" alt="微信公众号：bugstack虫洞栈 &amp; Turbine监控模型"></p><h2 id="环境准备" tabindex="-1"><a class="header-anchor" href="#环境准备" aria-hidden="true">#</a> 环境准备</h2><ol><li>jdk 1.8、idea2018、Maven3</li><li>Spring Boot 2.0.6.RELEASE</li><li>Spring Cloud Finchley.SR2</li></ol><h2 id="代码示例" tabindex="-1"><a class="header-anchor" href="#代码示例" aria-hidden="true">#</a> 代码示例</h2><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code>itstack<span class="token operator">-</span>demo<span class="token operator">-</span>springcloud<span class="token operator">-</span><span class="token number">05</span>
...
│           └── resources   
│               └── application<span class="token punctuation">.</span>yml
└── itstack<span class="token operator">-</span>demo<span class="token operator">-</span>springcloud<span class="token operator">-</span>turbine
    └── src
        └── main
            ├── java
            │   └── org<span class="token punctuation">.</span>itstack<span class="token punctuation">.</span>demo   
            │        └── <span class="token class-name">TurbineApplication</span><span class="token punctuation">.</span>java
            └── resources   
                └── application<span class="token punctuation">.</span>yml
...
eureka<span class="token operator">:</span>
  client<span class="token operator">:</span>
    serviceUrl<span class="token operator">:</span>
      defaultZone<span class="token operator">:</span> http<span class="token operator">:</span><span class="token operator">/</span><span class="token operator">/</span>localhost<span class="token operator">:</span><span class="token number">7397</span><span class="token operator">/</span>eureka<span class="token operator">/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="itstack-demo-springcloud-turbine-监控信息聚合服务" tabindex="-1"><a class="header-anchor" href="#itstack-demo-springcloud-turbine-监控信息聚合服务" aria-hidden="true">#</a> itstack-demo-springcloud-turbine | 监控信息聚合服务</h3><p>通过配置汇总，将应用itstack-demo-springcloud-feign,itstack-demo-springcloud-ribbon，汇总监控。</p><blockquote><p>TurbineApplication.java | 通过注解@EnableTurbine配置启动Ribbon</p></blockquote><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
 * 微信公众号：bugstack虫洞栈 | 沉淀、分享、成长，专注于原创专题案例
 * 论坛：http://bugstack.cn
 * Create by 付政委 on @2019
 */</span>
...
<span class="token punctuation">}</span>
  ...
  application<span class="token operator">:</span>
    name<span class="token operator">:</span> itstack<span class="token operator">-</span>demo<span class="token operator">-</span>springcloud<span class="token operator">-</span>turbine
...
eureka<span class="token operator">:</span>
  client<span class="token operator">:</span>
    service<span class="token operator">-</span>url<span class="token operator">:</span>
      defaultZone<span class="token operator">:</span> http<span class="token operator">:</span><span class="token operator">/</span><span class="token operator">/</span>localhost<span class="token operator">:</span><span class="token number">7397</span><span class="token operator">/</span>eureka

## 监控汇总配置，这里配置<span class="token number">2</span>个应用逗号隔开
turbine<span class="token operator">:</span>
  app<span class="token operator">-</span>config<span class="token operator">:</span> itstack<span class="token operator">-</span>demo<span class="token operator">-</span>springcloud<span class="token operator">-</span>feign<span class="token punctuation">,</span>itstack<span class="token operator">-</span>demo<span class="token operator">-</span>springcloud<span class="token operator">-</span>ribbon
  cluster<span class="token operator">-</span>name<span class="token operator">-</span>expression<span class="token operator">:</span> <span class="token keyword">new</span> <span class="token class-name">String</span><span class="token punctuation">(</span><span class="token string">&quot;default&quot;</span><span class="token punctuation">)</span>
  combine<span class="token operator">-</span>host<span class="token operator">-</span>port<span class="token operator">:</span> <span class="token boolean">true</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="测试验证" tabindex="-1"><a class="header-anchor" href="#测试验证" aria-hidden="true">#</a> 测试验证</h2><ol><li><p>启动itstack-demo-springcloud-hystrix-dashboard，访问；http://localhost:8989/hystrix <img src="https://bugstack.cn/assets/images/pic-content/2019/11/springcloud-4-3.png" alt="微信公众号：bugstack虫洞栈 &amp; hystrix-dashboard"></p></li><li><p>分别启动如下系统模拟；</p><ol><li>itstack-demo-springcloud-eureka-server 服务注册发现中心</li><li>itstack-demo-springcloud-eureka-client 测试接口提供方</li><li>itstack-demo-springcloud-hystrix-feign 接口调用方Feign</li><li>itstack-demo-springcloud-hystrix-ribbon 接口调用方Ribbon</li><li>itstack-demo-springcloud-turbine 监控信息汇总</li></ol></li><li><p>测试监控</p><ol><li>在hystrix-dashboard监控页面｛http://localhost:8989/hystrix｝，输入；http://localhost:8080/turbine.stream</li><li>刷新访问两个调用方接口；http://localhost:9001/api/queryUserInfo?userId=111、http://localhost:9002/api/queryUserInfo?userId=111</li><li>回看刚才的监控页面；http://localhost:8989/hystrix/monitor?stream=http%3A%2F%2Flocalhost%3A8080%2Fturbine.stream，已经可以看到监控信息汇总，如图； <img src="https://bugstack.cn/assets/images/pic-content/2019/11/springcloud-5-2.png" alt="微信公众号：bugstack虫洞栈 &amp; 监控信息汇总"></li></ol></li></ol><h2 id="综上总结" tabindex="-1"><a class="header-anchor" href="#综上总结" aria-hidden="true">#</a> 综上总结</h2><ol><li>通过Turbine服务我们可以将监控信息汇总到一起进行查看，这样更加方便实际应用。</li><li>SpringCloud 到现在的案例已经使用到了很多服务模块，它确实是一套有序集合框架，将各家优秀功能服务集成，方便使用。</li><li>SpringBoot 、 SpringCloud，在开发一些中小型独立服务非常边界，对于一些超大型以外的公司非常合适。当然并不是一线互联网就不使用，因为这里面还牵扯到很多对应的替代产品，比如Dubbo、网关、全链路监控、路由等等，所以需要根据不同业务进行技术选型，不要被技术限制。</li></ol><p>微信搜索「<strong>bugstack虫洞栈</strong>」公众号，关注后回复「<strong>SpringCloud专题</strong>」获取本文源码&amp;更多原创专题案例！</p>`,67);function v(m,b){const a=t("ExternalLinkIcon");return p(),i("div",null,[r,n("p",null,[s("作者：小傅哥 "),u,s("博客："),n("a",d,[s("https://bugstack.cn"),o(a)])]),k])}const h=e(c,[["render",v],["__file","2019-11-05-Spring Cloudwu《Turbine jiankongxinxijuhezhanshi Hystrix》.html.vue"]]);export{h as default};
