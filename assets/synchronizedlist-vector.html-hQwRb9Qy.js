import{_ as i,r as o,o as r,c as d,a as n,b as e,d as a,w as s,e as c}from"./app-3RcBQnkC.js";const l={},p=n("p",null,"Vector是java.util包中的一个类。 SynchronizedList是java.util.Collections中的一个静态内部类。",-1),m=c(`<p><strong>那么，到底SynchronizedList和Vector有没有区别，为什么java api要提供这两种线程安全的List的实现方式呢？</strong></p><p>首先，我们知道Vector和Arraylist都是List的子类，他们底层的实现都是一样的。所以这里比较如下两个<code>list1</code>和<code>list2</code>的区别：</p><pre><code>List&lt;String&gt; list = new ArrayList&lt;String&gt;();
List list2 =  Collections.synchronizedList(list);
Vector&lt;String&gt; list1 = new Vector&lt;String&gt;();
</code></pre><h2 id="一、比较几个重要的方法。" tabindex="-1"><a class="header-anchor" href="#一、比较几个重要的方法。" aria-hidden="true">#</a> 一、比较几个重要的方法。</h2><h3 id="_1-1-add方法" tabindex="-1"><a class="header-anchor" href="#_1-1-add方法" aria-hidden="true">#</a> 1.1 add方法</h3><p><strong>Vector的实现：</strong></p><pre><code>public void add(int index, E element) {
...
</code></pre><p>从上面两段代码中发现有两处不同： <strong>1.Vector使用同步方法实现，synchronizedList使用同步代码块实现。 2.两者的扩充数组容量方式不一样（两者的add方法在扩容方面的差别也就是ArrayList和Vector的差别。）</strong></p><h3 id="_1-2-remove方法" tabindex="-1"><a class="header-anchor" href="#_1-2-remove方法" aria-hidden="true">#</a> 1.2 remove方法</h3><p><strong>synchronizedList的实现：</strong></p><pre><code>public E remove(int index) {
