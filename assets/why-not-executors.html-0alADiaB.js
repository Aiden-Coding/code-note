...
</code></pre><p>通过上述方式创建线程时，不仅可以避免OOM的问题，还可以自定义线程名称，更加方便的出错的时候溯源。</p><p>思考题，文中作者说：发生异常（Exception）要比发生错误（Error）好，为什么这么说？</p><p>文中提到的《阿里巴巴Java开发手册》，请关注公众号Hollis，回复：手册。即可获得完整版PDF。</p>`,44);function E(g,m){const c=t("ExternalLinkIcon");return a(),d("div",null,[e("p",null,[o("在《"),e("a",l,[o("深入源码分析Java线程池的实现原理"),n(c)]),o("》这篇文章中，我们介绍过了Java中线程池的常见用法以及基本原理。")]),p,s,e("p",null,[o("关于这个问题，在那篇文章中并没有深入的展开。作者之所以这么说，是因为这种创建线程池的方式有很大的隐患，稍有不慎就有可能导致线上故障，如：一次Java线程池误用引发的血案和总结（ "),e("a",h,[o("https://zhuanlan.zhihu.com/p/32867181"),n(c)]),o(" ）")]),x])}const T=r(i,[["render",E],["__file","why-not-executors.html.vue"]]);export{T as default};
