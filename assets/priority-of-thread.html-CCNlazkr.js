...
</code></pre><p>在上面的代码中，Java虚拟机启动时，就会通过main方法启动一个线程，JVM就会一直运行下去，直到以下任意一个条件发生：</p><ul><li>调用了exit()方法，并且exit()有权限被正常执行。</li><li>所有的“非守护线程”都死了(即JVM中仅仅只有“守护线程”)。</li></ul>`,12),a=[o];function d(h,p){return r(),e("div",null,a)}const y=t(n,[["render",d],["__file","priority-of-thread.html.vue"]]);export{y as default};
