...
threshold : 24
loadFactor : 0.75
</code></pre><p>当HashMap中的元素个数达到13的时候，capacity就从16扩容到32了。</p><p>HashMap中还提供了一个支持传入initialCapacity,loadFactor两个参数的方法，来初始化容量和装载因子。不过，一般不建议修改loadFactor的值。</p><h3 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h3><p>HashMap中size表示当前共有多少个KV对，capacity表示当前HashMap的容量是多少，默认值是16，每次扩容都是成倍的。loadFactor是装载因子，当Map中元素个数超过<code>loadFactor* capacity</code>的值时，会触发扩容。<code>loadFactor* capacity</code>可以用threshold表示。</p><p>PS：文中分析基于JDK1.8.0_73</p>`,22);function M(F,_){const e=l("ExternalLinkIcon");return s(),i("div",null,[u,h,r,t("p",null,[t("a",d,[q,o(e)])]),g,t("p",null,[a("默认情况下，一个HashMap的容量（capacity）是16，设计成16的好处我在《"),t("a",m,[a("全网把Map中的hash()分析的最透彻的文章，别无二家。"),o(e)]),a("》中也简单介绍过，主要是可以使用按位与替代取模来提升hash的效率。")]),y])}const S=c(n,[["render",M],["__file","hashmap-capacity.html.vue"]]);export{S as default};
