import{_ as e,o as a,c as l,e as t}from"./app-3RcBQnkC.js";const r={},n=t(`<p>自从Java 1.5开始，提供了Callable和Future，通过它们可以在任务执行完毕之后得到任务执行结果。</p><pre><code>public class MultiThreads {
...
</code></pre><p>一般，我们会把Callable放到线程池中，然后让线程池去执行Callable中的代码。关于线程池前面介绍过了，是一种避免重复创建线程的开销的技术手段，线程池也可以用来创建线程。</p>`,13),u=[n];function s(c,o){return a(),l("div",null,u)}const i=e(r,[["render",s],["__file","create-thread-with-callback-future-task.html.vue"]]);export{i as default};
