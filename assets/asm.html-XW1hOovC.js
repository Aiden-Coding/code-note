import{_ as i,r as l,o as t,c,a as n,b as s,d,e as a}from"./app-3RcBQnkC.js";const o="/code-note/assets/image-60-Ki3osnet.png",p="/code-note/assets/image-61-dRAacp9z.png",u="/code-note/assets/image-54-zR6P22W4.png",r="/code-note/assets/image-55-UFiazv6y.png",v="/code-note/assets/image-62-pOY51F7D.png",m={},b=a('<h1 id="史上最通俗易懂的asm教程" tabindex="-1"><a class="header-anchor" href="#史上最通俗易懂的asm教程" aria-hidden="true">#</a> 史上最通俗易懂的ASM教程</h1><h2 id="一勺思想" tabindex="-1"><a class="header-anchor" href="#一勺思想" aria-hidden="true">#</a> 一勺思想</h2><p>We are all in the gutter, but some of us are looking at the stars. （我们都生活在阴沟里，但仍有人仰望星空 ）- 王尔德 《温德米尔夫人的扇子》</p><p>举世混浊我独清，众人皆醉我独醒 - 屈原 《楚辞》</p><h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2><p>ASM是一种通用Java字节码操作和分析框架。它可以用于修改现有的class文件或动态生成class文件。</p>',6),k={href:"https://asm.ow2.io/performance.html",target:"_blank",rel:"noopener noreferrer"},h=a('<p>本篇文章分享的是对ASM的理解和应用，之前需要我们掌握<strong>class字节码</strong>，<strong>JVM基于栈的设计模式,JVM指令</strong></p><h2 id="class字节码" tabindex="-1"><a class="header-anchor" href="#class字节码" aria-hidden="true">#</a> class字节码</h2><p>我们编写的java文件，会通过javac命令编译为class文件，JVM最终会执行该类型文件来运行程序。下图所示为class文件结构。</p><p><img src="'+o+`" alt="Alt text"></p><p>下面我们通过一个简单的实例来进行说明。下面是我们编写的一个简单的java文件，只是简单的函数调用.</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Test</span> <span class="token punctuation">{</span>
...
mv.visitMaxs(2, 3);
mv.visitEnd();
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以看出ASM是在指令层次上操作字节码的，和class字节码更加接近。如果我们有些字节码操作的需求，ASM一定可以实现的。只是使用起来比较麻烦一些。这里强烈推荐一款ASM插件</p><blockquote><p>https://plugins.jetbrains.com/plugin/5918-asm-bytecode-outline</p></blockquote><p>可以一键生成对应的ASM API代码</p><p><img src="`+v+'" alt="Alt text"></p><hr><blockquote><p>参考链接：https://zhuanlan.zhihu.com/p/94498015</p></blockquote><hr>',48);function g(f,I){const e=l("ExternalLinkIcon");return t(),c("div",null,[b,n("blockquote",null,[n("p",null,[s("**ASM **is an all purpose Java bytecode manipulation and analysis framework. It can be used to modify existing classes or to dynamically generate classes, directly in binary form. ASM provides some common bytecode transformations and analysis algorithms from which custom complex transformations and code analysis tools can be built. ASM offers similar functionality as other Java bytecode frameworks, but is focused on"),n("a",k,[s("performance"),d(e)]),s(". Because it was designed and implemented to be as small and as fast as possible, it is well suited for use in dynamic systems (but can of course be used in a static way too, e.g. in compilers).")])]),h])}const y=i(m,[["render",g],["__file","asm.html.vue"]]);export{y as default};
