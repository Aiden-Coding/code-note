import{_ as t,o as e,c as a,e as n}from"./app-3RcBQnkC.js";const r={},i=n(`<p><code>ArrayList</code>使用了<code>transient</code>关键字进行存储优化，而<code>Vector</code>没有这样做，为什么？</p><h3 id="arraylist" tabindex="-1"><a class="header-anchor" href="#arraylist" aria-hidden="true">#</a> ArrayList</h3><pre><code>/** 
...
</code></pre><p>ArrayList实现了writeObject方法，可以看到只保存了非null的数组位置上的数据。即list的size个数的elementData。需要额外注意的一点是，ArrayList的实现，提供了fast-fail机制，可以提供弱一致性。</p><h3 id="vector" tabindex="-1"><a class="header-anchor" href="#vector" aria-hidden="true">#</a> Vector</h3><pre><code>/**
