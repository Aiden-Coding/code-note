import{_ as n,o as s,c as a,e as t}from"./app-cCF93fuz.js";const e={},i=t(`<p>H2是一个开源的嵌入式（非嵌入式设备）数据库引擎，它是一个用Java开发的类库，可直接嵌入到应用程序中，与应用程序一起打包发布，不受平台限制。</p><p>H2与Derby、HSQLDB、MySQL、PostgreSQL等开源数据库相比，H2的优势为：</p><ul><li>Java开发，不受平台限制；</li><li>H2只有一个jar包，占用空间小，适合嵌入式数据库；</li><li>有web控制台，用于管管理数据库。</li></ul><p>接下来介绍Spring+Mybatis+H2的数据库访问实践，参考：https://blog.csdn.net/xktxoo/article/details/78014739</p><p>添加H2数据库依赖：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;dependency&gt;
