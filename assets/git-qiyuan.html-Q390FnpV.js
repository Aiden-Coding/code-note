import{_ as a,r as d,o as l,c as r,a as e,b as i,d as n,e as s}from"./app-3RcBQnkC.js";const c="/code-note/assets/image-13-BzPtM2ux.png",o="/code-note/assets/image-14-FBDgeNYL.png",m="/code-note/assets/image-15-GQpEbb_1.png",p="/code-note/assets/image-16-6TIwu1I0.png",u="/code-note/assets/image-17-DQllMzel.png",v="/code-note/assets/image-18-WuW4rT3j.png",g="/code-note/assets/image-19-U8ensMgz.png",b="/code-note/assets/image-20-9mmyt7bB.png",h="/code-note/assets/image-21-kv7UKg4D.png",x="/code-note/assets/image-22-qn3UDgtQ.png",_="/code-note/assets/image-23-yRr6rrg3.png",f="/code-note/assets/image-24-Xgdf1Y4D.png",G="/code-note/assets/image-25-LQPPKbaF.png",A="/code-note/assets/image-26-7GPK5qg3.png",k="/code-note/assets/image-27-XkbGXSRl.png",S="/code-note/assets/image-28-VecFHgG9.png",E="/code-note/assets/image-29-HZGnVPka.png",H="/code-note/assets/image-30-J_vWdJ13.png",$="/code-note/assets/image-31-ykR1W4RA.png",q="/code-note/assets/image-32-dCVrL0_0.png",L="/code-note/assets/image-33-RH1M-7ar.png",w="/code-note/assets/image-34-uEaRsSyg.png",y="/code-note/assets/image-35-SxjDZPVG.png",T="/code-note/assets/image-36-431XJ6yz.png",D="/code-note/assets/image-37-TRdf2V7e.png",R="/code-note/assets/image-38-f8TPEXQ0.png",B="/code-note/assets/image-39-qPk3vA0_.png",M="/code-note/assets/image-9-XXs_cWjr.png",N="/code-note/assets/image-8--JWHp3VM.png",C="/code-note/assets/image-10-ja-bCeWP.png",V="/code-note/assets/image-11-H0HnCdOT.png",j="/code-note/assets/image-12-snOxm0yl.png",P="/code-note/assets/image-40-28pU57-S.png",W="/code-note/assets/image-41-O83eZzQm.png",J="/code-note/assets/image-42-7iGKcZQG.png",z="/code-note/assets/image-43-ZCElGY9Z.png",O="/code-note/assets/image-44-gkS-25wa.png",I="/code-note/assets/image-45-DTPPH9AK.png",K="/code-note/assets/image-46-ooOr0ACA.png",Q="/code-note/assets/image-47-HUIZff_C.png",U="/code-note/assets/image-48-41BvyDAT.png",F="/code-note/assets/image-49-pAzaJt6G.png",X="/code-note/assets/image-50-x4tsqjlh.png",Y="/code-note/assets/image-51-fBktPjhi.png",Z="/code-note/assets/image-52-D38udbhG.png",ee="/code-note/assets/image-53-Ia6H0TWK.png",ie="/code-note/assets/image-54-JTqMgJqk.png",te="/code-note/assets/image-55-RBxWjyG4.png",ne="/code-note/assets/image-56-VoMSZ7xw.png",se="/code-note/assets/image-57-ZG-ujlB_.png",ae="/code-note/assets/image-58-4JDmlNh0.png",de="/code-note/assets/image-59-xUbNmffF.png",le="/code-note/assets/image-60-nSd0pgaP.png",re="/code-note/assets/image-61-ROIvIeTX.png",ce="/code-note/assets/image-62-ExhRShai.png",oe="/code-note/assets/image-63-8bsmFFQp.png",me="/code-note/assets/image-64-K4Ja5QWs.png",pe="/code-note/assets/image-65-HeISQyBi.png",ue="/code-note/assets/image-66-ETV6hBng.png",ve="/code-note/assets/image-67-LDw0-qT3.png",ge={},be=s('<h1 id="_1小时彻底掌握-git-可能是-史上最简单明了的-git-教程" tabindex="-1"><a class="header-anchor" href="#_1小时彻底掌握-git-可能是-史上最简单明了的-git-教程" aria-hidden="true">#</a> 1小时彻底掌握 Git，（可能是）史上最简单明了的 Git 教程</h1><h2 id="一、git-起源" tabindex="-1"><a class="header-anchor" href="#一、git-起源" aria-hidden="true">#</a> 一、Git 起源</h2><p>Git 是一个分布式版本控制系统，缔造者是大名鼎鼎的林纳斯·托瓦茲 (Linus Torvalds)，Git 最初的目的是为了能更好的管理 Linux 内核源码。</p><p><img src="'+c+'" alt="Alt text"></p><p>大家都知道，Linux 内核是开源的，参与者众多，到目前为止，共有两万多名开发者给 Linux Kernel 提交过代码。</p><p>但在 1991 年到 2002 年期间，Linus 作为项目的管理员并没有借助任何配置管理工具，而是以手工方式通过 patch 来合并大家提交的代码。</p><p>倒不是说 Linus 喜欢手工处理，而是因为他对代码版本管理工具非常挑剔，无论是商用的 clearcase，还是开源的 CVS、SVN 都入不了他的法眼。</p><p>直到 2002 年，Linus 才相中了一款分布式版本控制系统 BitKeeper，虽然是商用的，但 BitKeeper 愿意让 Linux 社区免费使用，这让 Linus 非常开心和满意。</p><p>时间来到 2005 年，由于 BitKeeper 提供的默认接口不能满足 Linux 社区用户的全部需要，一位开发者在未经允许的情况下反编译了 BitKeeper 并利用了未公开的接口，于是 BitKeeper 的著作权拥有者拉里·麦沃伊就气愤地收回了 Linux 社区免费使用的权力。</p><p>没办法，Linus 只好自己硬着头皮上了。他对新的版本控制系统制订了若干目标：</p><ul><li>速度</li><li>设计简单</li><li>允许成千上万个并行开发的分支</li><li>完全分布式</li><li>有能力高效管理类似 Linux 内核一样的超大规模项目</li></ul><p>结果，令人意想不到的是，Linus 只用了 10 天时间就用 C语言完成了第一个版本，嗯。。神就是神。并且给这个版本起了一个略带嘲讽意味的名字——Git（在英式英语俚语中表示“不愉快的人”）。</p><p>源代码的自述文件有进一步的阐述：</p><blockquote><p>The name &quot;git&quot; was given by Linus Torvalds when he wrote the very first version. He described the tool as &quot;the stupid content tracker&quot; and the name as (depending on your way)</p></blockquote><p>从 Git 的设计上来看，有两种命令：分别是底层命令(Plumbing commands)和高层命令(Porcelain commands)。一开始，Linus 只设计了一些给开源社区的黑客们使用的符合 Unix KISS 原则的命令，因为黑客们本身就是动手高手，水管坏了就撸起袖子去修理，因此这些命令被称为 plumbing commands。</p><p>Linus 在提交了第一个 git commit 后，就向社区发布了 git 工具。当时，社区中有位叫 Junio Hamano 的开发者觉得这个工具很有意思，便下载了代码，结果发现一共才 1244 行代码，这更令他惊奇，也引发了极大的兴趣。Junio 在邮件列表与 Linus 交流并帮助增加了 merge 等功能，而后持续打磨 git，最后 Junio 完全接手了 Git 的维护工作，Linus 则回去继续维护 Linux Kernel 项目。</p><p>Junio Hamano 觉得 Linus 设计的这些命令对于普通用户不太友好，因此在此之上，封装了更易于使用、接口更精美的高层命令，也就是我们今天每天使用的 git add, git commit 之类。Git add 就是封装了 update-cache 命令，而 git commit 就是封装了 write-tree, commit-tree 命令。</p><p>如果选历史上最伟大的一次 Git 代码提交，那一定是这 Git 工具项目本身的第一次代码提交。这次代码提交无疑是开创性的，<strong>如果说 Linux 项目促成了开源软件的成功并改写了软件行业的格局，那么 Git 则是改变了全世界开发者的工作方式和写作方式</strong>。</p><p>如今，Git 已经成为全球软件开发者的标配。</p><p><img src="'+o+'" alt="Alt text"></p><p>原本的 Git 只适用于 Unix/Linux 平台，但随着 Cygwin、msysGit 环境的成熟，以及 TortoiseGit 这样易用的GUI工具，Git 在 Windows 平台下也逐渐成熟。</p><blockquote><p>PS1：Cygwin 的主要目的是通过重新编译，将 POSIX 系统（例如Linux、BSD，以及其他Unix系统）上的软件移植到Windows上。</p></blockquote><blockquote><p>PS2：msysGit 前面的 4 个字幕来源于 MSYS 项目，而 MSYS 又源于 MinGW（Minimalist GNU for Windows，最简GNU工具集），通过增加了一个由bash提供的shell环境以及其他相关工具软件，组成了一个最简系统（Minimal System），利用MinGW提供的工具，以及Git针对MinGW的一个分支版本，可以在Windows平台为Git编译出一个原生应用，结合MSYS就组成了msysGit。</p></blockquote><p>Git 和传统的版本控制工具 CVS、SVN 有不小的区别，前者关心的是文件的整体性是否发生了改变，后两者更关心文件内容上的差异。</p><p><img src="'+m+'" alt="Alt text"></p><p>除此之外，Git 更像是一个文件系统，每个使用它的主机都可以作为版本库，并且不依赖于远程仓库而离线工作。开发者在本地就有历史版本的副本，因此就不用再被远程仓库的网络传输而束缚。</p><p>Git 中的绝大多数操作都只需要访问本地文件和资源，一般不需要来自网络上其它计算机的信息。因为在本地磁盘上就有项目的完整历史，所以 Git 的大部分操作看起来就像是在瞬间完成的。</p><p>在多人协作的情况下，Git 可以将本地仓库复制给其他开发者，那些发生改变的文件可以作为新增的分支被导入，再与本地仓库的进行分支合并。</p><p>如果你希望后面的学习更顺利，请记住 Git 这三种状态：</p><ul><li>已提交（committed），表示数据已经安全的保存在本地数据库中</li><li>已修改（modified），表示修改了文件，但还没保存到数据库中</li><li>已暂存（staged），表示对一个已修改文件的当前版本做了标记，使之包含在下次提交的快照中</li></ul><p>由此引入了 Git 的三个工作区域：</p><ul><li>Git 仓库，用来保存项目的元数据和对象数据库</li><li>工作目录，对项目的某个版本进行独立提取</li><li>暂存区域，保存了下次将提交的文件列表信息，也可以叫“索引”</li></ul><p>Git 的工作流程是这样的：</p><p><img src="'+p+'" alt="Alt text"></p><ul><li>在工作目录中修改文件</li><li>暂存文件，将文件的快照放入暂存区域</li><li>提交更新，找到暂存区域的文件，将快照永久性存储到 Git 仓库目录</li></ul><h2 id="二、git-安装" tabindex="-1"><a class="header-anchor" href="#二、git-安装" aria-hidden="true">#</a> 二、Git 安装</h2><p>接下来，我们来看一下 <strong>Git 的安装</strong>，Linux 和 Windows 系统的安装大家可以到 Git 官网上查看安装方法，上面讲的非常详细。</p><blockquote><p>https://git-scm.com/downloads</p></blockquote><p><img src="'+u+'" alt="Alt text"></p><p>我个人使用的 macOS 系统，可以直接使用 <code>brew install git</code> 命令安装，非常方便。</p><p><img src="'+v+`" alt="Alt text"></p><p>安装成功后，再使用 <code>git --version</code> 就可以查看版本号了，我本机上安装的是 2.23.0 版本。</p><h2 id="三、git-的数据模型" tabindex="-1"><a class="header-anchor" href="#三、git-的数据模型" aria-hidden="true">#</a> 三、Git 的数据模型</h2><p>尽管 Git 的接口有些难懂，但它底层的设计和思想却非常的优雅。难懂的接口只能靠死记硬背，但优雅的底层设计则非常容易理解。我们可以通过一种自底向上的方式来学习 Git，先了解底层的数据模型，再学习它的接口。可以这么说，一旦搞懂了 Git 的数据模型，再学习它的接口并理解这些接口是如何操作数据模型的就非常容易了。</p><p>进行版本控制的方法很多，Git 拥有一个精心设计的模型，这使其能够支持版本控制所需的所有特性，比如维护历史记录、支持分支和团队协作。</p><h3 id="快照" tabindex="-1"><a class="header-anchor" href="#快照" aria-hidden="true">#</a> 快照</h3><p>Git 将顶级目录中的文件和文件夹称作集合，并通过一系列快照来管理历史记录。在 Git 的术语中，文件被称为 blob 对象（数据对象），也就是一组数据。目录则被称为 tree（树），目录中可以包含文件和子目录。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;root&gt; (tree)
|
+- foo (tree)
|  |
...
$ git archive
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="六、图解-git-分支" tabindex="-1"><a class="header-anchor" href="#六、图解-git-分支" aria-hidden="true">#</a> 六、图解 Git 分支</h2><p>相比同类软件，Git有很多优点。其中很显著的一点，就是版本的分支（branch）和合并（merge）十分方便。</p><p>有些传统的版本管理软件，分支操作实际上会生成一份现有代码的物理拷贝，而Git只生成一个指向当前版本（又称&quot;快照&quot;）的指针，因此非常快捷易用。</p><p>但是，太方便了也会产生副作用。如果你不加注意，很可能会留下一个枝节蔓生、四处开放的版本库，到处都是分支，完全看不出主干发展的脉络。</p><p><img src="`+x+'" alt="Alt text"></p><p>那有没有一个好的分支策略呢？答案当然是有的。</p><h3 id="_1、主分支master" tabindex="-1"><a class="header-anchor" href="#_1、主分支master" aria-hidden="true">#</a> 1、主分支Master</h3><p>首先，代码库应该有一个、且仅有一个主分支。所有提供给用户使用的正式版本，都在这个主分支上发布。</p><p><img src="'+_+'" alt="Alt text"></p><p>Git主分支的名字，默认叫做Master。它是自动建立的，版本库初始化以后，默认就是在主分支在进行开发。</p><h3 id="_2、开发分支develop" tabindex="-1"><a class="header-anchor" href="#_2、开发分支develop" aria-hidden="true">#</a> 2、开发分支Develop</h3><p>主分支只用来发布重大版本，日常开发应该在另一条分支上完成。我们把开发用的分支，叫做Develop。</p><p><img src="'+f+`" alt="Alt text"></p><p>这个分支可以用来生成代码的最新隔夜版本（nightly）。如果想正式对外发布，就在Master分支上，对Develop分支进行&quot;合并&quot;（merge）。</p><p>Git创建Develop分支的命令：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>　　git checkout -b develop master
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>最后一种是修补bug分支</strong>。软件正式发布以后，难免会出现bug。这时就需要创建一个分支，进行bug修补。</p><p>修补bug分支是从Master分支上面分出来的。修补结束以后，再合并进Master和Develop分支。它的命名，可以采用fixbug-*的形式。</p><p><img src="`+S+`" alt="Alt text"></p><p>创建一个修补bug分支：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>　　git checkout -b fixbug-0.1 master
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="七、git-实战" tabindex="-1"><a class="header-anchor" href="#七、git-实战" aria-hidden="true">#</a> 七、Git 实战</h2><p>对于新手来说，Git 操作确实容易给代码的版本库带来一些不必要的混乱，毕竟大学的时候，学习的重点在编程语言上，在计算机基础上。可一旦参加了工作，就必须得在代码版本库上狠下一番功夫了，毕竟要多人运动啊，不，多人协作啊。</p><h3 id="_1、创建仓库" tabindex="-1"><a class="header-anchor" href="#_1、创建仓库" aria-hidden="true">#</a> 1、创建仓库</h3><p>仓库，也就是 repository，可以简单理解为一个目录，这个目录里面的所有文件都将被 Git 管理起来，每个文件的一举一动，都将被 Git 记录下来，以便在任何时刻进行追踪和回滚。</p><p>新建一个文件夹，比如说 testgit，然后使用 <code>git init</code> 命令就可以把这个文件夹初始化为 Git 仓库了。</p><p><img src="`+E+'" alt="Alt text"></p><p>初始化Git 仓库成功后，可以看到多了一个 .git 的目录，没事不要乱动，免得破坏了 Git 仓库的结构。</p><p>接下来，我们来新增一个文件 readme.txt，内容为“老铁，记得给二哥三连啊”，并将其提交到 Git 仓库。</p><p>第一步，使用 <code>git add</code> 命令将新增文件添加到暂存区。</p><p>第二步，使用 <code>git commit</code> 命令告诉 Git，把文件提交到仓库。</p><p><img src="'+H+'" alt="Alt text"></p><p>可以使用 <code>git status</code> 来查看是否还有文件未提交。</p><p>也可以在文件中新增一行内容“传统美德不能丢，记得点赞哦~”，再使用 <code>git status</code> 来查看结果。</p><p><img src="'+$+'" alt="Alt text"></p><p>如果想查看文件到底哪里做了修改，可以使用 <code>git diff</code> 命令：</p><p><img src="'+q+'" alt="Alt text"></p><p>确认修改的内容后，可以使用 <code>git add</code> 和 <code>git commit</code> 再次提交。</p><h3 id="_2、版本回滚" tabindex="-1"><a class="header-anchor" href="#_2、版本回滚" aria-hidden="true">#</a> 2、版本回滚</h3><p>再次对文件进行修改，追加一行内容为：“xxx，我爱你❤”，并且提交到 Git 仓库。</p><p>现在我已经对 readme.txt 文件做了三次修改了。可以通过 <code>git log</code> 命令来查看历史记录：</p><p><img src="'+L+'" alt="Alt text"></p><p>也可以通过 <code>gitk</code> 这个命令来启动图形化界面来查看版本历史。</p><p><img src="'+w+'" alt="Alt text"></p><p>如果想回滚的话，比如说回滚到上一个版本，可以执行以下两种命令：</p><p>1）<code>git reset --hard HEAD^</code>，上上个版本就是 <code>git reset --hard HEAD^^</code>，以此类推。</p><p>2）<code>git reset --hard HEAD~100</code>，如果回滚到前 100 个版本，用这个命令比上一个命令更方便。</p><p><img src="'+y+'" alt="Alt text"></p><p>那假如回滚错了，想恢复，不记得版本号了，可以先执行 <code>git reflog</code> 命令查看版本号：</p><p><img src="'+T+'" alt="Alt text"></p><p>然后再通过 <code>git reset --hard</code> 命令来恢复：</p><p><img src="'+D+'" alt="Alt text"></p><h3 id="_3、工作区和暂存区的区别" tabindex="-1"><a class="header-anchor" href="#_3、工作区和暂存区的区别" aria-hidden="true">#</a> 3、工作区和暂存区的区别</h3><p>工作区和暂存区的概念其实在前面的章节里强调过了，但考虑到有些小伙伴在 <code>git add</code> 和 <code>git commit</code> 命令之间仍然有一些疑惑，我们这里就再强调一次——学习知识就是这样，只有不厌其烦地重复，才能真正地理解和掌握。</p><p>1）<strong>工作区</strong>，比如说前面提到的 testgit 目录就属于工作区，我们操作的 readme.txt 文件就放在这个里面。</p><p>2）<strong>暂存区</strong>，隐藏目录 .git 不属于工作区，它（Git 仓库）里面存了很多东西，其中最重要的就是暂存区。</p><p>Git 在提交文件的时候分两步，第一步 <code>git add</code> 命令是把文件添加到暂存区，第二步 <code>git commit</code> 才会把暂存区的所有内容提交到 Git 仓库中。</p><p>“<strong>为什么要先 add 才能 commit 呢？</strong>”</p><p>最直接的原因就是Linus 搞了这个“暂存区”的概念。那为什么要搞这个概念呢？没有暂存区不行吗？</p><p>嗯，要回答这个问题，我们就需要追本溯源了。</p><p>在 Git 之前， SVN 是代码版本管理系统的集大成者。SVN 比之前的 CVS 更优秀的一点是，每次的提交可以由多个文件组成，并且这次提交是原子性的，要么全部成功，要么全部失败。</p><p>原子性带来的好处是显而易见的，这使得我们可以把项目整体还原到某个时间点，就这一点，SVN 就完虐 CVS 这些代码版本管理系统了。</p><p><img src="'+R+'" alt="Alt text"></p><p>Git 作为逼格最高的代码版本管理系统，自然要借鉴 SVN 这个优良特性的。但不同于 SVN 的是，Git 一开始搞的都是命令行，没有图形化界面，如果想要像 SVN 那样一次性选择多个文件或者不选某些文件（见上图），还真特喵的是个麻烦事。</p><p>对于像 Linus 这种天才级选手来说，图形化界面无疑是 low 逼，可命令行在这种情况下又实在是麻烦~</p><p>嗯，怎么办呢？</p><p>神之所以为神，就是他能在遇到问题的时候想到完美的解决方案——搞个<strong>暂存区</strong>不就完事了？</p><p>暂存区可以随意地将各种文件的修改放进去，只需要通过 <code>git add</code> 这种简单的命令就可以精心地挑选要提交哪些文件了，然后再一次性（原子性）的 <code>git commit</code> 到版本库，所有的问题都迎刃而解嘛。</p><p>我们在 testgit 目录下再新增一个文件 readyou.txt，内容为“二哥，我要和你约饭~~~”；并且在 readme.txt 文件中再追加一行内容“点赞、在看、留言、转发一条龙服务~”。</p><p>我们先用 <code>git status</code> 命令查看一下状态，再用 <code>git add</code> 将文件添加到暂存区，最后再用 <code>git commit</code> 一次性提交到 Git 仓库。</p><p><img src="'+B+'" alt="Alt text"></p><h3 id="_4、撤销修改" tabindex="-1"><a class="header-anchor" href="#_4、撤销修改" aria-hidden="true">#</a> 4、撤销修改</h3><p>现在，我在 readyou.txt 文件中追加了一行内容：“二哥，我想和你约会~~~”。在我想要提交的时候，突然发现追加的内容有误，我得恢复到以前的版本，该怎么办呢？</p><p>1）我知道要修改的内容，直接修改，然后 add 和 commit 覆盖。</p><p>2）我忘记要修改哪些内容了，通过 <code>git reset -- hard HEAD</code> 恢复到上一个版本。</p><p>还有其他办法吗？</p><p>答案当然是有了，其实在我们执行 <code>git status</code> 命令查看 Git 状态的时候，结果就提示我们可以使用 <code>git restore</code> 命令来撤销这次操作的。</p><p><img src="'+M+'" alt="Alt text"></p><p>那其实在 git version 2.23.0 版本之前，是可以通过 <code>git checkout</code> 命令来完成撤销操作的。</p><p><img src="'+N+'" alt="Alt text"></p><p>checkout 可以创建分支、导出分支、切换分支、从暂存区删除文件等等，一个命令有太多功能就容易让人产生混淆。2.23.0 版本改变了这种混乱局面，git switch 和 git restore 两个新的命令应运而生。</p><p>switch 专注于分支的切换，restore 专注于撤销修改。</p><p><img src="'+C+'" alt="Alt text"></p><h3 id="_5、远程仓库" tabindex="-1"><a class="header-anchor" href="#_5、远程仓库" aria-hidden="true">#</a> 5、远程仓库</h3><p>Git 是一款分布式版本控制系统，所以同一个 Git 仓库，可以分布到不同的机器上。一开始，只有一台机器和一个原始版本库，往后去，别的机器就可以从这台机器上拷贝原始版本，就像黑客帝国里的那个特工史密斯一样，没有任何区别。</p><p>这也是 Git 比集中式版本控制系统 SVN 特别的地方之一。</p><p>我们可以自己搭建一台每天 24 小时可以运转的 Git 服务器，然后其他人就从这台“服务器”中拷贝就行了。不过，因为 GitHub 的存在，自主搭建 Git 服务器这个步骤就可以省了。</p><p>从名字上就可以看得出来，GitHub 是用来提供 Git 仓库托管服务的，我们<strong>只需要注册一个 GitHub 账号</strong>，就可以免费获取一台每天可以运转 24 小时的 Git 远程服务器。</p><p>那其实在 GitHub 上有对应的中文帮助文档，来介绍如何通过 SSH 协议将本机和 GitHub 链接起来，从而不必在每次访问时提供用户名和密码。</p><blockquote><p>https://docs.github.com/cn/authentication/connecting-to-github-with-ssh/about-ssh</p></blockquote><p><strong>第一步，通过 <code>ls -al ~/.ssh</code> 命令检查 SSH 密钥是否存在</strong></p><p><img src="'+V+`" alt="Alt text"></p><p>如果没有 id_rsa.pub、id_ecdsa.pub、id_ed25519.pub 这 3 个文件，表示密钥不存在。</p><p><strong>第二步，生成新 SSH 密钥</strong></p><p>执行以下命令，注意替换成你的邮箱：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>ssh-keygen -t ed25519 -C &quot;your_email@example.com&quot;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>然后一路回车：</p><p><img src="`+j+'" alt="Alt text"></p><p>记得复制一下密钥，在 id_ed25519.pub 文件中：</p><p><img src="'+P+'" alt="Alt text"></p><p><strong>第三步，添加 SSH 密钥到 GitHub 帐户</strong></p><p>在个人账户的 settings 菜单下找到 SSH and GPG keys，将刚刚复制的密钥添加到 key 这一栏中，点击「add SSH key」提交。</p><p><img src="'+W+'" alt="Alt text"></p><p>Title 可不填写，提交成功后会列出对应的密钥：</p><p><img src="'+J+'" alt="Alt text"></p><p><strong>为什么 GitHub 需要 SSH 密钥呢</strong>？</p><p>因为 GitHub 需要确认是“你本人”在往你自己的远程仓库上提交版本的，而不是别人冒充的。</p><p><strong>第四步，在 GitHub 上创建个人仓库</strong></p><p>点击新建仓库，填写仓库名称等信息：</p><p><img src="'+z+'" alt="Alt text"></p><p><strong>第五步，把本地仓库同步到 GitHub</strong></p><p>复制远程仓库的地址：</p><p><img src="'+O+'" alt="Alt text"></p><p>在本地仓库中执行 <code>git remote add</code> 命令将 GitHub 仓库添加到本地：</p><p><img src="'+I+`" alt="Alt text"></p><p>当我们第一次使用Git 的 push 命令连接 GitHub 时，会得到一个警告⚠️：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>The authenticity of host &#39;github.com (20.205.243.166)&#39; can&#39;t be established.
ECDSA key fingerprint is SHA256:p2QAMXNIC1TJYWeIOttrVc98/R1BUFWu3/LiyKgUfQM.
Are you sure you want to continue connecting (yes/no/[fingerprint])? yes
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这是因为需要你手动确认，输入 yes 即可。</p><p>接下来，我们使用 <code>git push</code> 命令将当前本地分支推送到 GitHub。加上了 -u 参数后，Git 不但会把本地的 master 分支推送的远程 master 分支上，还会把本地的 master 分支和远程的master 分支关联起来，在以后的推送或者拉取时就可以简化命令（比如说 <code>git push github master</code>）。</p><p><img src="`+K+'" alt="Alt text"></p><p>此时，我们刷一下 GitHub，可以看到多了一个 master 分支，并且本地的两个文件都推送成功了！</p><p><img src="'+Q+'" alt="Alt text"></p><p>从现在开始，只要本地做了修改，就可以通过 <code>git push</code> 命令推送到 GitHub 远程仓库了。</p><p>还可以使用 <code>git clone</code> 命令将远程仓库拷贝到本地。比如说我现在有一个 3.4k star 的仓库 JavaBooks，</p><p><img src="'+U+'" alt="Alt text"></p><p>然后我使用 <code>git clone</code> 命令将其拷贝到本地。</p><p><img src="'+F+'" alt="Alt text"></p><h2 id="八、详解-sparse-checkout-命令" tabindex="-1"><a class="header-anchor" href="#八、详解-sparse-checkout-命令" aria-hidden="true">#</a> 八、详解 sparse-checkout 命令</h2><p>前天不是搭建了一个《二哥的Java进阶之路》的网站嘛，其中用到了 Git 来作为云服务器和 GitHub 远程仓库之间的同步工具。</p><p><img src="'+X+'" alt="Alt text"></p><p>给大家介绍一个牛逼的命令——<code>git sparse-checkout</code>，帮我的云服务器剩下了至少一半的存储空间。</p><h3 id="_1、使用-git-中遇到的一个大麻烦" tabindex="-1"><a class="header-anchor" href="#_1、使用-git-中遇到的一个大麻烦" aria-hidden="true">#</a> 1、使用 Git 中遇到的一个大麻烦</h3>',190),ke={href:"https://javabetter.cn",target:"_blank",rel:"noopener noreferrer"},Se=e("p",null,[e("img",{src:Y,alt:"Alt text"})],-1),Ee=e("p",null,[i("正所谓"),e("strong",null,"不积跬步无以至千里，不积小流无以成江海"),i("。")],-1),He=e("p",null,"1000 次也许不值一提，但 1000 万也不过是 1 万个 1000，二哥取得的每一点点进步，都要感谢大家的倾力捧场。",-1),$e={href:"https://mp.weixin.qq.com/s/NtOD5q95xPEs4aQpu4lGcg",target:"_blank",rel:"noopener noreferrer"},qe=e("code",null,"git pull",-1),Le={href:"https://mp.weixin.qq.com/s/OYOcjUwPZyPo8K4KAgJ4kw",target:"_blank",rel:"noopener noreferrer"},we=s('<p>直接 <code>git pull</code> 会无脑把 GitHub 上的 codes、images 目录同步到云服务器上，但其实 codes、images 目录是不需要同步的。</p><p>具体是怎么一回事呢？</p><p>大家可以先看一下我这个 GitHub 仓库的目录结构哈。</p><p><img src="'+Z+'" alt="Alt text"></p><ul><li>docs 是文档目录，里面是 md 文件，所有的教程原稿都在这里。</li><li>codes 是代码目录，里面是教程的配套源码。</li><li>images 是图片目录，里面是教程的配套手绘图。</li></ul><p>这样就可以利用 GitHub 来做免费的图床，并且还可以白票 jsDelivr CDN 的全球加速，简直不要太爽！</p><p><img src="'+ee+'" alt="Alt text"></p><p>比如说 images 目录下有一张 logo 图 logo-01.png：</p><p><img src="'+ie+'" alt="Alt text"></p><p>如果使用 GitHub 仓库的原始路径来访问的话，速度贼慢！</p><blockquote><p>https://github.com/itwanger/toBeBetterJavaer/tree/master/images/logo-01.png</p></blockquote><p>使用 jsDelivr 加速后就不一样了，速度飞起！</p><p><img src="'+te+'" alt="Alt text"></p><p>简单总结下 GitHub 作为图床的正确用法，就两条：</p><ul><li>创建一个 GitHub 仓库作为图床仓库，上传提交图片到仓库中</li><li>在要使用 GitHub 图床图片的地方将链接换为 <code>https://cdn.jsdelivr.net/gh/{user}/{repo}/图片路径</code></li></ul><p>付费七牛云或者阿里云图床的小伙伴不妨试试这种方式，能白票咱绝不花一分冤枉钱。</p><p>那也就是说，《二哥的Java进阶之路》网站上的图片都是通过 GitHub 图床加载的，不需要将图片从 GitHub 仓库拉取到云服务器上。要知道，一台云服务器的空间是极其昂贵的，能省的空间咱必须得省。</p><h3 id="_2、学习-git-中遇到的一个大惊喜" tabindex="-1"><a class="header-anchor" href="#_2、学习-git-中遇到的一个大惊喜" aria-hidden="true">#</a> 2、学习 Git 中遇到的一个大惊喜</h3><p>于是我今天早上就在琢磨着，怎么样才能把这昂贵的空间省下来呢？</p><p>我百度了很多帖子，绝大多数都乱七八糟，毫无价值，能说到点子上的几乎没有。</p>',20),ye={href:"https://mp.weixin.qq.com/s/RpFzXOa2VlFNd7ylLmr9LQ",target:"_blank",rel:"noopener noreferrer"},Te=e("strong",null,"git sparse-checkout，它可以帮助我们在拉取远程仓库的时候只同步那些我们想要的目录和文件",-1),De=e("p",null,[e("img",{src:ne,alt:"Alt text"}),i(" 具体怎么用，可以看官方文档：")],-1),Re={href:"https://git-scm.com/docs/git-sparse-checkout",target:"_blank",rel:"noopener noreferrer"},Be=s('<p>但没必要，hhhh，我们直接实战。</p><p>第一步，通过 <code>git remote add -f orgin git@github.com:itwanger/toBeBetterJavaer.git</code> 命令从 GitHub 上拉取仓库。</p><p><img src="'+se+'" alt="Alt text"></p><p>第二步，启用 sparse-checkout，并初始化</p><p>拉取到仓库后，执行 <code>git config core.sparseCheckout true</code> 命令启用 sparse-checkout。</p><p>然后再执行 <code>git sparse-checkout init</code> 初始化。</p><p><img src="'+ae+'" alt="Alt text"></p><p>第三步，使用 sparse-checkout 来拉取我们想要的仓库目录</p><p><img src="'+de+'" alt="Alt text"></p><p>比如说，我们只想拉取 docs 目录，可以执行 <code>git sparse-checkout set docs</code> 命令。</p><p><img src="'+le+'" alt="Alt text"></p><p>如果是第一次使用 sparse-checkout 的话，还需要执行一下 <code>git pull orgin master</code> 命令拉取一次。</p><p><img src="'+re+'" alt="Alt text"> 第四步，验证是否生效</p><p>可以执行 <code>ls -al</code> 命令来确认 sparse-checkout 是否生效。</p><p><img src="'+ce+'" alt="Alt text"></p><p>如图所示，确实只拉取到了 docs 目录。</p><p>假如还想要拉取其他文件或者目录的话，可以通过 <code>git sparse-checkout add</code> 命令来添加。</p><p><img src="'+oe+'" alt="Alt text"></p><p>这就实现了，<strong>远程仓库和云服务器仓库之间的定制化同步，需要什么目录和文件就同步什么目录和文件，不需要的可以统统不要</strong>。</p><p>GitHub 仓库可以免费用，空间也无限大，但云服务可是要抠抠搜搜的用，毕竟扩充存储空间是真的贵！</p><p>我对比了一下，远程仓库大概 145 M，图片就占了 72 M，妥妥地省下了一半的存储空间。</p><p><img src="'+me+'" alt="Alt text"></p><p>如何禁用 git sparse-checkout 呢？</p><p>也简单，只需要执行一下 <code>git sparse-checkout disable</code> 命令就可以了。</p><p><img src="'+pe+'" alt="Alt text"></p><p>可以看到，那些我们不想要的目录和文件统统都又回来了。</p><p>如果重新启用呢？</p><p>也简单，只需要执行一下 <code>git sparse-checkout reapply</code> 命令就可以了。</p><p><img src="'+ue+'" alt="Alt text"></p><p>简单总结下：如果你要把一个庞大到撑满你硬盘的远程仓库拉取到本地，而你只需要其中的一部分目录和文件，那就可以试一试 <code>git sparse-checkout</code> 了。</p><h3 id="_3、使用-git-后的一点心里话" tabindex="-1"><a class="header-anchor" href="#_3、使用-git-后的一点心里话" aria-hidden="true">#</a> 3、使用 Git 后的一点心里话</h3><p>不得不说，Git 实在是太强大了。就一行命令，解决了困扰我一天的烦恼，我的 80G 存储空间的云服务器又可以再战 3 年了，从此以后再也不用担心了。</p><p><img src="'+ve+'" alt="Alt text"></p><p>Git 是真的牛逼，Linus 是真的牛逼，神不愧是神！</p><hr><p>推荐阅读：</p>',36),Me={href:"https://mp.weixin.qq.com/s/RpFzXOa2VlFNd7ylLmr9LQ",target:"_blank",rel:"noopener noreferrer"},Ne={href:"https://mp.weixin.qq.com/s/lY79hI7URuFh3gD9DJKInQ",target:"_blank",rel:"noopener noreferrer"},Ce={href:"https://mp.weixin.qq.com/s/Z766Egape2QicYndsQjZ4g",target:"_blank",rel:"noopener noreferrer"},Ve=e("p",null,"参考资料：",-1),je={href:"https://zh.wikipedia.org/wiki/Git",target:"_blank",rel:"noopener noreferrer"},Pe={href:"https://mp.weixin.qq.com/s/gM__sQPILkAKWsMejOO8cA",target:"_blank",rel:"noopener noreferrer"},We=e("hr",null,null,-1);function Je(ze,Oe){const t=d("ExternalLinkIcon");return l(),r("div",null,[be,e("p",null,[i("在 Git 专题的"),e("a",he,[i("开篇"),n(t)]),i("，我就提醒大家一定要记住这几个专用名词，对掌握 Git 有很大的帮助：")]),xe,_e,fe,e("blockquote",null,[e("p",null,[e("a",Ge,[i("http://www.ruanyifeng.com/blog/2015/12/git-cheat-sheet.html"),n(t)])])]),Ae,e("p",null,[i("首先给大家通报一下，一天前"),e("a",ke,[i("上线的《二哥的Java进阶之路》网站"),n(t)]),i("，目前访问次数已经突破 1000 了。")]),Se,Ee,He,e("p",null,[i("看过"),e("a",$e,[i("上一篇搭建过程"),n(t)]),i("的小伙伴应该都知道了，我是通过在云服务器上 clone 了一份 GitHub 上的远程仓库，然后通过宝塔面板的定时任务执行 "),qe,i(" 命令从 GitHub 上拉取到最新的内容，再通过 "),e("a",Le,[i("Nginx 服务器"),n(t)]),i("搭建的网站，网站内容是通过 docsify 渲染 md 文件得到的。")]),we,e("p",null,[i("最后还是浏览 Git 官方手册（也可以看"),e("a",ye,[i("Pro Git"),n(t)]),i("）才找到了一个牛逼的命令："),Te,i("。")]),De,e("blockquote",null,[e("p",null,[e("a",Re,[i("https://git-scm.com/docs/git-sparse-checkout"),n(t)])])]),Be,e("blockquote",null,[e("ul",null,[e("li",null,[e("a",Me,[i("下载→豆瓣9.1分的 Pro Git 学习手册 YYDS！"),n(t)])]),e("li",null,[e("a",Ne,[i("摸清 Git 的门路，就靠这 22 张图"),n(t)])]),e("li",null,[e("a",Ce,[i("保姆级Git入门教程，万字详解"),n(t)])])])]),Ve,e("blockquote",null,[e("ul",null,[e("li",null,[i("维基百科："),e("a",je,[i("https://zh.wikipedia.org/wiki/Git"),n(t)])]),e("li",null,[i("hutusi："),e("a",Pe,[i("改变世界的一次代码提交"),n(t)])])])]),We])}const Ke=a(ge,[["render",Je],["__file","git-qiyuan.html.vue"]]);export{Ke as default};
