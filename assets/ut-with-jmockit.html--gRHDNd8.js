...
</code></pre><h3 id="_2-基于状态的mock方式" tabindex="-1"><a class="header-anchor" href="#_2-基于状态的mock方式" aria-hidden="true">#</a> (2).基于状态的Mock方式：</h3><p>JMockit上面的基于行为Mock方式和传统的EasyMock和PowerMock流程基本类似，相当于把被模拟的方法当作黑盒来处理，而JMockit的基于状态的Mock可以直接改写被模拟方法的内部逻辑，更像是真正意义上的白盒测试，下面通过简单例子介绍JMockit基于状态的Mock。 被测试的代码如下：</p><pre><code>public class StateMocked {  
...
</code></pre><p>原文链接: http://blog.csdn.net/chjttony/article/details/17838693</p>`,35);function q(w,_){const n=c("ExternalLinkIcon");return s(),a("div",null,[r,t("p",null,[t("a",p,[u,o(n)])]),d,k,M,g,t("p",null,[t("a",h,[m,o(n)])]),b])}const E=e(l,[["render",q],["__file","ut-with-jmockit.html.vue"]]);export{E as default};
