...
![image-20220324093855618](../pics/ad5cc8fc-d59b-45ce-8899-63a18320d97e.gif)



① 如果一个节点的右子树不为空，那么该节点的下一个节点是右子树的最左节点；

![image-20220324093855618](../pics/7008dc2b-6f13-4174-a516-28b2d75b0152.gif)

② 否则，向上找第一个左链接指向的树包含该节点的祖先节点。

![image-20220324093855618](../pics/094e3ac8-e080-4e94-9f0a-64c25abc695e.gif)
